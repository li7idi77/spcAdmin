...
<script src="https://code.jquery.com/ui/1.12.1/jquery-ui.js"></script>
 ...
 function fn_goList(){
	document.location = "<c:url value='/user/instructor01List.do'/>";
}	
</script>
     <!-- container  begin -->
                <div id="container">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <c:if test="${not empty result.NEXT_NM}">
                                            	<td colspan="5" class="tl"><a class="link" href="<c:url value='/user/instructor01View.do'/>?board_idx=${result.NEXT_IDX}">${result.NEXT_NM}</a></td>
                                            </c:if>
                                        ...
                                        <tr>
                                            ...
                                            <c:if test="${not empty result.PREV_NM}">
                                            	<td colspan="5" class="tl"><a class="link" href="<c:url value='/user/instructor01View.do'/>?board_idx=${result.PREV_IDX}">${result.PREV_NM}</a></td>
                                            </c:if>
