 ...
 function fn_basket(edu_no){
		...
		if(confirm("장바구니에 등록 하시겠습니까?")){
			...
			formData.append("edu_no",   $("#edu_no").val());
			 ...
			 $.ajax({	
					data       : formData,
				    url		   : "<c:url value='/user/sectorSaveCheck.do'/>",
				    dataType   : "JSON",
			        processData: false, 
			        contentType: false,
					type	   : "POST",	
		...
		<input type="hidden" id="file_id" name="file_id">
                ...
                <div id="container">
                    ...
                    <div class="contents-wrap">
                        ...
                        <!---- button begin ---->
                        <div class="btn-cont">
                        	<c:if test="${sessionId.edu_auth_cd == '01'|| sessionId.edu_auth_cd == '02'|| sessionId.edu_auth_cd == '03'|| sessionId.edu_auth_cd == '04'}">
