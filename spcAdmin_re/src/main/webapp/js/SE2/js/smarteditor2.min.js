...
function fontProperty(e, t, i, n, o) {
    this.fontId = e, this.fontName = t, this.defaultSize = i, this.fontURL = n, this.fontCSSURL = o, this.displayName = t, this.isLoaded = !0, this.fontFamily = this.fontId, "" != this.fontCSSURL ? (this.displayName += "" + i, this.fontFamily += "_" + i, this.isLoaded = !1, this.loadCSS = function(e) {
        ...
        var t = e.styleSheets.length,
            i = e.styleSheets[t - 1];
        (0 === t || i.imports.length > 30) && (i = e.createElement("style"), e.documentElement.firstChild.appendChild(i), i = i.sheet || i.styleSheet), i.addImport(this.fontCSSURL)
...
function Shortcut(e, t) {
    var e = e.replace(/\s+/g, ""),
        i = Shortcut.Store,
        n = Shortcut.Action;
    if ("undefined" == typeof t && e.constructor == String) return i.set("document", e, document), n.init(i.get("document"), e);
    ...
    if (t.constructor != String && e.constructor == String) {
        ...
        return o = Shortcut.Store.searchId(o, t), i.set(o, e, t), n.init(i.get(o), e)
    }
    alert(t + "는 반드시 string이거나  없어야 됩니다.")
}
"undefined" == typeof window.nhn && (window.nhn = {}), nhn.husky || (nhn.husky = {}),
    function() {
        var e = /^\$(LOCAL|BEFORE|ON|AFTER)_/,
            t = /^\$(BEFORE|ON|AFTER)_MSG_APP_READY$/,
            i = [],
            n = {};
        nhn.husky.HuskyCore = jindo.$Class({
            ...
            $init: function(e) {
                this.htOptions = e || {}, i.push(this), this.htOptions.oDebugger && (nhn.husky.HuskyCore.getCore = function() {
                    return i
            ...
            exec: function(e, t, i) {
                return this.appStatus == nhn.husky.APP_STATUS.NOT_READY ? (this.messageQueue[this.messageQueue.length] = {
                    msg: e,
                    args: t,
                    event: i
                }, !0) : (this.exec = this._exec, void this.exec(e, t, i))
            },
            ...
            _doExec: function(e, t, i) {
                ...
                if (!this.oDisabledMessage[e]) {
                    var s = [];
                    if (t && t.length)
                        for (var r = t.length, a = 0; r > a; a++) s[a] = t[a];
                    i && (s[s.length] = i), n = this._execMsgStep("BEFORE", e, s), n && (n = this._execMsgStep("ON", e, s)), n && (n = this._execMsgStep("AFTER", e, s))
                }
                return n
            },
            registerPlugin: function(t) {
                if (!t) throw "An error occured in registerPlugin(): invalid plug-in";
                if (t.nIdx = this.aPlugins.length, t.oApp = this, this.aPlugins[t.nIdx] = t, t.status != nhn.husky.PLUGIN_STATUS.NOT_READY && (t.status = nhn.husky.PLUGIN_STATUS.READY), this.appStatus != nhn.husky.APP_STATUS.NOT_READY)
                    for (var i in t) e.test(i) && this.addToMessageMap(i, t);
            ...
            run: function(e) {
                ...
                for (var t = this.messageQueue.length, i = 0; t > i; i++) {
            ...
            createMessageMap: function(e) {
                this.oMessageMap[e] = [];
                for (var t = this.aPlugins.length, i = 0; t > i; i++) this._doAddToMessageMap(e, this.aPlugins[i])
            },
            ...
            _execMsgHandler: function(e, i) {
                var n;
                this.oMessageMap[e] || this.createMessageMap(e);
                var o = this.oMessageMap[e],
                    s = o.length;
                if (0 === s) return !0;
                var r = !0;
                if (t.test(e)) {
                    for (n = 0; s > n; n++)
                        if (this._execHandler(o[n], e, i) === !1) {
                            r = !1;
                            break
                        }
                } else
                    for (n = 0; s > n; n++)
                        if ((o[n]._husky_bRun || (o[n]._husky_bRun = !0, "function" != typeof o[n].$LOCAL_BEFORE_FIRST || this._execHandler(o[n], "$LOCAL_BEFORE_FIRST", [e, i]) !== !1)) && ("function" != typeof o[n].$LOCAL_BEFORE_ALL || this._execHandler(o[n], "$LOCAL_BEFORE_ALL", [e, i]) !== !1) && this._execHandler(o[n], e, i) === !1) {
                            r = !1;
                            break
                        } return r
            },
            ...
            _doAddToMessageMap: function(e, t) {
                if ("function" == typeof t[e]) {
                    for (var i = this.oMessageMap[e], n = 0, o = i.length; o > n; n++)
                        if (this.oMessageMap[e][n] == t) return;
                    this.oMessageMap[e][n] = t
                }
            },
            ...
            _loadLazyFiles: function(e, t, i, o, s) {
                var r = o.length;
                if (s >= r) return this.oLazyMessage[e] = null, void this.oApp.exec(e, t, i);
                var a = o[s];
                n[a] ? this._loadLazyFiles(e, t, i, o, s + 1) : jindo.LazyLoading.load(nhn.husky.SE2M_Configuration.LazyLoad.sJsBaseURI + "/" + a, jindo.$Fn(function(e, t, i, o, s) {
                    var r = o[s];
                    n[r] = 1, this._loadLazyFiles(e, t, i, o, s + 1)
                }, this).bind(e, t, i, o, s), "utf-8")
            },
            registerLazyMessage: function(e, t) {
                e = e || [], t = t || [];
                for (var i, n, o = 0; i = e[o]; o++) n = this.oLazyMessage[i], n ? n.aFilenames = n.aFilenames.concat(t) : this.oLazyMessage[i] = {
                    sMsg: i,
                    aFilenames: t
                }
            }
            ...
            n[e] = 1
        }, nhn.husky.HuskyCore.mixin = function(t, n, o, s) {
            for (var r, a = [], l = 0; r = i[l]; l++)
                for (var h, d = 0; h = r.aPlugins[d]; d++)
                    if (h instanceof t) a.push(h), "function" != typeof h.$LOCAL_BEFORE_FIRST && h.oApp.acceptLocalBeforeFirstAgain(h, !0);
                    else if (h._$superClass === t) {
                "function" != typeof h.$LOCAL_BEFORE_FIRST && h.oApp.acceptLocalBeforeFirstAgain(h, !0);
                for (var c in n)(o || !h.hasOwnProperty(c)) && (h[c] = n[c], e.test(c) && h.oApp.addToMessageMap(c, h))
            }
            for (var c in n)
                if ((o || !t.prototype.hasOwnProperty(c)) && (t.prototype[c] = n[c], e.test(c)))
                    for (var h, d = 0; h = a[d]; d++) h.oApp.addToMessageMap(c, h)
        ...
        this.getCommonAncestorContainer = function() {
            ...
            return e.rangeCount < 1 ? !0 : e.getRangeAt(0).collapsed
        ...
        $init: function() {
            ...
            e.ie && document.selection ? nhn.CurrentSelection_IE.apply(this) : nhn.CurrentSelection_FF.apply(this)
        },
        ...
        cloneContents: function() {
            ...
            }), n.oStartContainer && n.oStartContainer.previousSibling && nhn.DOMFix.parentNode(n.oStartContainer).removeChild(n.oStartContainer.previousSibling), n.oEndContainer && n.oEndContainer.nextSibling && nhn.DOMFix.parentNode(n.oEndContainer).removeChild(n.oEndContainer.nextSibling), e
        },
        _constructClonedTree: function(e, t) {
            var i = null,
                ...
                r = function(e, t, r) {
                    ...
                    var a = t - 1,
                        l = e[t].cloneNode(!1);
                    for (e[t] == o && (i = l), e[t] == s && (n = l); a >= 0 && nhn.DOMFix.parentNode(e[a]) == e[t];) a = this._recurConstructClonedTree(e, a, l);
                    return r.insertBefore(l, r.firstChild), a
                };
            return this._recurConstructClonedTree = r, e[e.length] = nhn.DOMFix.parentNode(e[e.length - 1]), this._recurConstructClonedTree(e, e.length - 1, t), {
                oStartContainer: i,
                oEndContainer: n
            }
        },
        ...
        _getCommonAncestorContainer: function(e, t) {
            e = e || this.startContainer, t = t || this.endContainer;
            for (var i = t; e;) {
                for (; i;) {
                    if (e == i) return e;
        ...
        getInsertBeforeNodes: function() {
            var e, t = null;
            return "3" == this.startContainer.nodeType ? (e = nhn.DOMFix.parentNode(this.startContainer), t = this.startContainer.nodeValue.length <= this.startOffset ? this.startContainer.nextSibling : this.startContainer.splitText(this.startOffset)) : (e = this.startContainer, t = nhn.DOMFix.childNodes(this.startContainer)[this.startOffset]), t && nhn.DOMFix.parentNode(t) || (t = null), {
                elParent: e,
                elBefore: t
            }
        },
        ...
        setEndAfter: function(e, t) {
            ...
            return "BODY" == e.tagName ? void this.setEnd(e, nhn.DOMFix.childNodes(e).length, !0, t) : void this.setEnd(nhn.DOMFix.parentNode(e), this._getPosIdx(e) + 1, !0, t)
        },
        setEndBefore: function(e, t) {
            if (!e) throw new Error("INVALID_NODE_TYPE_ERR in setEndBefore");
            return "BODY" == e.tagName ? void this.setEnd(e, 0, !0, t) : void this.setEnd(nhn.DOMFix.parentNode(e), this._getPosIdx(e), !0, t)
        },
        ...
        setStartAfter: function(e, t) {
            ...
            return "BODY" == e.tagName ? void this.setStart(e, nhn.DOMFix.childNodes(e).length, !0, t) : void this.setStart(nhn.DOMFix.parentNode(e), this._getPosIdx(e) + 1, !0, t)
        },
        setStartBefore: function(e, t) {
            if (!e) throw new Error("INVALID_NODE_TYPE_ERR in setStartBefore");
            return "BODY" == e.tagName ? void this.setStart(e, 0, !0, t) : void this.setStart(nhn.DOMFix.parentNode(e), this._getPosIdx(e), !0, t)
        },
        ...
        _isBlankTextNode: function(e) {
            return 3 == e.nodeType && "" == e.nodeValue ? !0 : !1
        },
        _isAllChildBlankText: function(e) {
            for (var t = 0, i = e.childNodes.length; i > t; t++)
        ...
        _updateRangeInfo: function() {
            return this.startContainer ? (this.collapsed = this.oBrowserSelection.isCollapsed(this) || this.startContainer === this.endContainer && this.startOffset === this.endOffset, void(this.commonAncestorContainer = this.oBrowserSelection.getCommonAncestorContainer(this))) : void this.reset(this._window)
        },
        ...
        _getActualStartNode: function(e, t) {
            var i = e;
            return 3 == e.nodeType ? t >= e.nodeValue.length ? (i = this._getNextNode(e), "BODY" == i.tagName && (i = null)) : i = e : t < nhn.DOMFix.childNodes(e).length ? i = nhn.DOMFix.childNodes(e)[t] : (i = this._getNextNode(e), "BODY" == i.tagName && (i = null)), i
        },
        _getActualEndNode: function(e, t) {
            var i = e;
            return 0 === t ? (i = this._getPrevNode(e), "BODY" == i.tagName && (i = null)) : i = 3 == e.nodeType ? e : nhn.DOMFix.childNodes(e)[t - 1], i
        },
        ...
        _recurGetNextNodesUntil: function(e, t, i) {
            ...
            for (var n = e.nextSibling; !n;) {
                ...
                if (i[this._nNodesBetweenLen++] = e, e == t) return !1;
                n = e.nextSibling
            }
        ...
        _recurGetChildNodesUntil: function(e, t, i) {
            ...
            return i[this._nNodesBetweenLen++] = e, n ? !1 : e == t ? !1 : !0
        }
        ...
        getNodeAroundRange: function(e, t) {
            ...
            if (this.startContainer && 3 == this.startContainer.nodeType) return this.startContainer;
            var i, n, o;
            return n = this.startOffset >= nhn.DOMFix.childNodes(this.startContainer).length ? this._getNextNode(this.startContainer) : nhn.DOMFix.childNodes(this.startContainer)[this.startOffset], i = 0 === this.endOffset ? this._getPrevNode(this.endContainer) : nhn.DOMFix.childNodes(this.endContainer)[this.endOffset - 1], e ? (o = i, o || t || (o = n)) : (o = n, o || t || (o = i)), o
        },
        ...
        _evaluateXPath: function(e, t) {
            ...
            for (var i = e.split(/\//), n = t.body, o = 2; o < i.length && n; o++) {
                i[o].match(/([^\[]+)\[(\d+)/i);
                for (var s = RegExp.$1, r = RegExp.$2, a = nhn.DOMFix.childNodes(n), l = [], h = a.length, d = 0, c = 0; h > c; c++) a[c].tagName == s && (l[d++] = a[c]);
        ...
        getXPathBookmark: function() {
            ...
            var n = this._getXPath(i),
                o = {
                    sXPath: n,
                    nTextNodeIdx: e,
                    nOffset: t.nOffset
                };
            if (this.collapsed) var s = {
                sXPath: n,
                nTextNodeIdx: e,
                nOffset: t.nOffset
            };
                ...
                var r = -1,
                    ...
                    l = this.endContainer;
                3 == l.nodeType && (a = this._getFixedEndTextNode(), r = this._getPosIdx(a.elContainer), l = nhn.DOMFix.parentNode(l));
                var h = this._getXPath(l),
                    s = {
                        sXPath: h,
                        nTextNodeIdx: r,
                        nOffset: a.nOffset
        ...
        placeStringBookmark_NonWebkit: function() {
            ...
            i.id = this.HUSKY_BOOMARK_END_ID_PREFIX + e, t.insertNode(i);
        ...
        placeStringBookmark_Webkit: function() {
            ...
            o.id = this.HUSKY_BOOMARK_END_ID_PREFIX + i, t.insertBefore(o, e);
            var n = this.cloneRange();
            n.collapseToStart(), e = this._document.createTextNode(""), n.insertNode(e), t = e.parentNode, e.nextSibling && "TD" == e.nextSibling.tagName && (t = e.nextSibling, e = t.firstChild);
        ...
        moveToStringBookmark: function(e, t) {
            ...
            return i && n ? (this.reset(this._window), t ? (this.setEndAfter(n), this.setStartBefore(i)) : (this.setEndBefore(n), this.setStartAfter(i)), !0) : !1
        },
        ...
        getTextNodes: function(e) {
            var t = function(e) {
                return 3 == e.nodeType && "\n" != e.nodeValue && "" != e.nodeValue ? !0 : !1
            };
            return this.getNodes(e, t)
        },
        ...
        isRangeinRange: function(e, t) {
            ...
            return 0 >= i && s >= 0 ? !0 : t ? 1 == n ? !1 : -1 == o ? !1 : !0 : !1
        },
        ...
        pasteHTML: function(e, t) {
            ...
            if (i.innerHTML = e, !i.firstChild) return void this.deleteContents();
            var n = this.cloneRange(),
            ...
            if (r.oLineBreaker && "P" === r.oLineBreaker.nodeName && (t || n.rxHasBlock.test(e))) {
                ...
                } else p = this._document.createElement("P"), p.style.cssText = r.oLineBreaker.style.cssText, p.align = r.oLineBreaker.align, l.appendChild(p);
                "" === p.innerHTML && (p.innerHTML = jindo.$Agent().navigator().ie && jindo.$Agent().navigator().version > 8 ? "​" : "\ufeff"), this.selectNodeContents(p), this.collapseToStart(), jindo.$Agent().navigator().ie && jindo.$Agent().navigator().version < 9 && (o = this.placeStringBookmark(), this.removeStringBookmark(o))
            } else {
                var u = i.firstChild,
                    g = i.lastChild;
        ...
        _hasTextDecoration: function(e, t) {
            return e && e.style ? e.style.textDecoration.indexOf(t) > -1 ? !0 : "underline" === t && "U" === e.tagName ? !0 : "line-through" !== t || "S" !== e.tagName && "STRIKE" !== e.tagName ? !1 : !0 : !1
        },
        ...
        _checkTextDecoration: function(e) {
            if ("SPAN" === e.tagName) {
                var t = !1,
                    i = !1,
                    n = null;
                for (oChildNode = e.firstChild; oChildNode;) {
                    if (1 === oChildNode.nodeType && (t = t || "U" === oChildNode.tagName, i = i || "S" === oChildNode.tagName || "STRIKE" === oChildNode.tagName), t && i) return;
        ...
        styleRange: function(e, t, i, n, o) {
            ...
            if (!(s.length < 1)) {
                for (var r, a, l = 0; l < s.length; l++) {
                    for (var h in e) r = h, a = e[r], "string" == typeof a && (o && e.color && this._checkTextDecoration(s[l]), s[l].style[r] = a);
                    if (t)
                        for (var h in t) r = h, a = t[r], "string" == typeof a && ("class" == r ? jindo.$Element(s[l]).addClass(a) : s[l].setAttribute(r, a))
                }
        ...
        expandStart: function() {
            if (3 != this.startContainer.nodeType || 0 === this.startOffset) {
                var e = this._getActualStartNode(this.startContainer, this.startOffset);
                e = this._getPrevNode(e), "BODY" == e.tagName ? this.setStartBefore(e) : this.setStartAfter(e)
            }
        },
        expandEnd: function() {
            if (!(3 == this.endContainer.nodeType && this.endOffset < this.endContainer.nodeValue.length)) {
                ...
                e = this._getNextNode(e), "BODY" == e.tagName ? this.setEndAfter(e) : this.setEndBefore(e)
            }
        },
        ...
        _findParentSingleSpan: function(e) {
            ...
            for (var t, i, n = 0, o = 0, s = e.childNodes; i = s[n]; n++)
                if (t = i.nodeValue, !this._rxCursorHolder.test(t) && (o++, o > 1)) return null;
        ...
        _isFullyContained: function(e, t, i) {
            ...
            return n = i && s == i ? 1 : t.indexOf(s), -1 != n && (s = this._getVeryLastRealChild(e), o = i && s == i ? 1 : t.indexOf(s)), -1 != n && -1 != o
        },
        ...
        _getLineStartInfo: function(e) {
            function t(e) {
                if (e && !n) {
                    if (a.test(e.tagName)) return s = e, n = o, void(r = !0);
                    o = e, i(e.previousSibling), n || t(nhn.DOMFix.parentNode(e))
                }
            }

            function i(e) {
                if (e && !n) {
                    if (a.test(e.tagName)) return s = e, n = o, void(r = !1);
                    o = e, n || i(e.previousSibling)
                }
            }
            var n = null,
                o = e,
                s = e,
                r = !1,
                a = this.rxLineBreaker;
            return a.test(e.tagName) ? n = e : t(e), {
                oNode: n,
                oLineBreaker: s,
                bParentBreak: r
            }
        ...
        _getLineEndInfo: function(e) {
            function t(e) {
                if (e && !n) {
                    if (a.test(e.tagName)) return s = e, n = o, void(r = !0);
                    o = e, i(e.nextSibling), n || t(nhn.DOMFix.parentNode(e))
                }
            }
        ...
        getLineInfo: function(e) {
            ...
            if (t != o || i != r) {
                ...
                0 >= a && l >= 0 || (t = this.getNodeAroundRange(!1, !0), i = this.getNodeAroundRange(!1, !0), n = this._getLineStartInfo(t), s = this._getLineEndInfo(i))
            }
            return {
                oStart: n,
                oEnd: s
        ...
        _findSingleChild: function(e) {
            ...
            for (var t, i, n = null, o = 0, s = 0, r = e.childNodes; i = r[o]; o++)
                if (t = i.nodeValue, !this._rxCursorHolder.test(t) && (n = i, s++, s > 1)) return null;
            return n
        },
        _hasCursorHolderOnly: function(e) {
            return e && 1 === e.nodeType ? this._rxCursorHolder.test(e.innerHTML) ? !0 : this._hasCursorHolderOnly(this._findSingleChild(e)) : !1
        }
        ...
        this._oSelection = this._document.selection, this.oLastRange = {
            ...
            e = e || 0;
            var t, i;
            if ("Control" == this._oSelection.type) {
                t = new nhn.W3CDOMRange(this._window);
                var n = this._oSelection.createRange().item(e);
                return n && n.ownerDocument == this._document ? (t.selectNode(n), t) : t
            }
            i = this._oSelection.createRange();
            var n = i.parentElement();
            return t = n && n.ownerDocument == this._document ? this._IERange2W3CRange(i) : new nhn.W3CDOMRange(this._window)
        }, this.addRange = function(e) {
            ...
            var i = null,
                n = null,
                o = 0;
            3 == e.nodeType ? (i = nhn.DOMFix.parentNode(e), n = nhn.DOMFix.childNodes(i), o = n.length) : (i = e, n = nhn.DOMFix.childNodes(i), o = t < n.length ? t : n.length);
            for (var s = null, r = 0, a = !0, l = 0; o > l; l++)
                if (s = n[l], 3 == s.nodeType) {
                    if (s == e) break;
            ...
            var t = new nhn.W3CDOMRange(this._window),
                i = null,
                n = null;
            i = e.duplicate(), i.collapse(!0), n = this._getW3CContainerAndOffset(i, !0), t.setStart(n.oContainer, n.iOffset, !0, !0);
            var o = e.duplicate();
            return o.collapse(!0), o.isEqual(e) ? t.collapse(!0) : (i = e.duplicate(), i.collapse(!1), n = this._getW3CContainerAndOffset(i), t.setEnd(n.oContainer, n.iOffset, !0)), this._updateLastRange(e, t), t
        }, this._getW3CContainerAndOffset = function(e, t) {
            for (var i = e, n = i.parentElement(), o = -1, s = this._document.body.createTextRange(), r = nhn.DOMFix.childNodes(n), a = null, l = 0, h = 0; h < r.length; h++)
                if (3 != r[h].nodeType) {
                    if (s.moveToElementText(r[h]), s.compareEndPoints("StartToStart", e) >= 0) break;
                    a = r[h]
                } var l = h;
            if (0 !== l && 3 == r[l - 1].nodeType) {
                var d = this._document.body.createTextRange(),
                    c = null;
                a ? (d.moveToElementText(a), d.collapse(!1), c = a.nextSibling) : (d.moveToElementText(n), d.collapse(!0), c = n.firstChild);
                var _ = i.duplicate();
                ...
                c.nodeValue;
                t && c.nextSibling && 3 == c.nextSibling.nodeType && p == c.nodeValue.length && (p -= c.nodeValue.length, c = c.nextSibling), n = c, o = p
            } else n = i.parentElement(), o = l;
            return {
                oContainer: n,
                iOffset: o
            }
        ...
        _childNodes_Fix: function(e) {
            ...
            if (e) {
                var t = [];
                for (e = e.firstChild; e;) t[i++] = e, e = e.nextSibling
            }
            return t
        }
        ...
        _loadFullPlugin: function(e, t, i, n, o, s) {
            jindo.LazyLoading.load(nhn.husky.SE2M_Configuration.LazyLoad.sJsBaseURI + "/" + e[s], jindo.$Fn(function(e, t, i, n, o, s) {
                var r = (e[s], e[0]);
                return s == e.length - 1 ? (this.htLazyLoadRequest_plugins[r].nStatus = 2, void this.oApp.exec("MSG_FULL_PLUGIN_LOADED", [e, t, i, n, o])) : void this._loadFullPlugin(e, t, i, n, o, s + 1)
        ...
        $ON_MSG_FULL_PLUGIN_LOADED: function(aFilenames, sClassName, sMsgName, oThisRef, oArguments, oRes) {
            ...
            for (var x in oPlugin) oThisRef.$this && (!oThisRef[x] || "function" == typeof oPlugin[x] && "constructor" != x) && (oThisRef[x] = jindo.$Fn(oPlugin[x], oPluginRef).bind()), oPlugin[x] && (!oPluginRef[x] || "function" == typeof oPlugin[x] && "constructor" != x) && (oPluginRef[x] = oPlugin[x], x.match(/^\$(LOCAL|BEFORE|ON|AFTER)_/) && this.oApp.addToMessageMap(x, oPluginRef));
        ...
        getEmptySelection: function(e) {
            var t = new nhn.HuskyRange(e || this.oWindow);
            return t
        },
        ...
        _assignHTMLElements: function(e) {
            ...
            for (var t = 0, i = this.aAllUI.length; i > t; t++)
                if (this.rxUI.test(this.aAllUI[t].className)) {
                    var n = RegExp.$1;
                    if (void 0 !== this.htUIList[n]) continue;
        ...
        $LOCAL_BEFORE_FIRST: function(e) {
            var t = jindo.$$(">ul>li[class*=" + this.sUIClassPrefix + "]>button", this.elTextTool),
                i = t.length;
            this.elFirstToolbarItem = this.elFirstToolbarItem || t[0], this.elLastToolbarItem = t[i - 1], this.oApp.registerBrowserEvent(this.toolbarArea, "keydown", "NAVIGATE_TOOLBAR", [])
        },
        $init: function(e, t) {
        ...
        $ON_NAVIGATE_TOOLBAR: function(e) {
            var t = 9;
            e.element == this.elLastToolbarItem && e.key().keyCode == t && (e.key().shift || (this.elFirstToolbarItem.focus(), e.stopDefault())), e.element == this.elFirstToolbarItem && e.key().keyCode == t && e.key().shift && (e.stopDefault(), this.elLastToolbarItem.focus())
        },
        ...
        $ON_DISABLE_ALL_UI: function(e) {
            if (2 !== this.nUIStatus) {
                ...
                n || this.oApp.exec("HIDE_ACTIVE_LAYER");
                for (t in this.htUIList) t && !i.has(t) && this._disableUI(t);
                this.nUIStatus = 2
            }
        },
        ...
        $ON_POSITION_TOOLBAR_LAYER: function(e, t) {
            ...
            if (e) {
                ...
                var h = jindo.$Element(e);
                "right" != a ? (e.style.left = "0", i = h.offset().left, n = i + e.offsetWidth, o = this.welToolbarArea.offset().left, s = o + this.toolbarArea.offsetWidth, n > s && h.css("left", s - n - l + "px"), o > i && h.css("left", o - i + l + "px")) : (e.style.right = "0", i = h.offset().left, n = i + e.offsetWidth, o = this.welToolbarArea.offset().left, s = o + this.toolbarArea.offsetWidth, n > s && h.css("right", -1 * (s - n - l) + "px"), o > i && h.css("right", -1 * (o - i + l) + "px"))
            }
        },
        ...
        $ON_EVENT_TOOLBAR_MOUSEDOWN: function(e) {
            for (var t = e.element; t;) {
                if (t.className && t.className.match(/active/) && (t.childNodes.length > 2 || t.parentNode.className.match(/se2_pair/))) return;
                t = t.parentNode
            }
            this.oApp.exec("HIDE_ACTIVE_LAYER_IF_NOT_CHILD", [e.element])
        },
        _enableUI: function(e) {
            if (!(this._htOptions._sDisabled && this._htOptions._sDisabled.indexOf("," + e + ",") > -1)) {
                var t, i;
                this.nUIStatus = 0;
                ...
                if (n) {
                    ...
                    for (t = 0, i = s.length; i > t; t++) s[t].disabled = !1;
                    var r = "";
                    if (this.aUICmdMap[e])
        ...
        _disableUI: function(e) {
            ...
            if (n) {
                ...
                var s = o.getElementsByTagName("BUTTON");
                for (t = 0, i = s.length; i > t; t++) s[t].disabled = !0;
                var r = "";
                if (this.aUICmdMap[e])
        ...
        _getAffectedElements: function(e) {
            ...
            if (!e.bSE2_MDCancelled) {
                ...
                for (var n = e.getElementsByTagName("BUTTON"), o = 0, s = n.length; s > o; o++) n[o].onmousedown = function() {
                    return !1
                }
            }
            if (!e || !e.tagName) return [];
            if ("BUTTON" == (t = e).tagName) return (t = t.parentNode) && "LI" == t.tagName && this.rxUI.test(t.className) ? [jindo.$Element(t)] : (t = e, (t = t.parentNode.parentNode) && "LI" == t.tagName && (i = jindo.$Element(t)).hasClass("se2_pair") ? [i, jindo.$Element(e.parentNode)] : []);
            if ("SPAN" == (t = e).tagName) {
        ...
        $ON_REGISTER_UI_EVENT: function(e, t, i, n) {
            if (this.htUIList[e]) {
                var o;
                this.aUICmdMap[e] || (this.aUICmdMap[e] = []), this.aUICmdMap[e][this.aUICmdMap[e].length] = i, o = jindo.$$.getSingle("button", this.htUIList[e]), o && this.oApp.registerBrowserEvent(o, t, i, n)
            }
        },
        ...
        _getSize: function(e, t) {
            var i, n, o, s, r, a = "px";
            for (t = parseInt(t, 10), i = 0, n = e.length; n > i; i++)
                if (e[i]) {
                    if (!isNaN(e[i])) {
                        s = parseInt(e[i], 10), r = a;
                        break
                    }
                    if (o = /([0-9]+)(.*)/i.exec(e[i]), !(!o || o.length < 2 || o[1] <= 0)) {
                        s = parseInt(o[1], 10), r = o[2], r || (r = a), t > s && r === a && (s = t);
                        break
                    }
                } return r || (r = a), (isNaN(s) || t > s && r === a) && (s = t), {
                nSize: s,
                sUnit: r
            }
        },
        ...
        $BEFORE_MSG_APP_READY: function(e) {
        ...
        $ON_MSG_APP_READY: function() {
            this.htOptions = this.oApp.htOptions[this.name] || {}, this.sDefaultEditingMode = this.htOptions.sDefaultEditingMode || this.sDefaultEditingMode, this.iframeWindow = this.oApp.getWYSIWYGWindow(), this.oApp.exec("REGISTER_CONVERTERS", []), this.oApp.exec("CHANGE_EDITING_MODE", [this.sDefaultEditingMode, !0]), this.oApp.exec("LOAD_CONTENTS_FIELD", [!1]), this.fOnBeforeUnload !== !1 && (this.fOnBeforeUnload ? window.onbeforeunload = this.fOnBeforeUnload : window.onbeforeunload = jindo.$Fn(function() {
                return this.getRawContents() != this.sCurrentRawContents || this.bIsDirty ? this.oApp.$MSG("SE_EditingAreaManager.onExit") : void 0
            }, this).bind())
        },
        $AFTER_MSG_APP_READY: function() {
        ...
        $BEFORE_CHANGE_EDITING_MODE: function(e) {
            return this.oEditingMode[e] ? (this.stopAutoResize(), this._oPrevActivePlugin = this.oActivePlugin, void(this.oActivePlugin = this.oEditingMode[e])) : !1
        },
        ...
        $BEFORE_SET_IR: function(e, t) {
            t = t || !1, t || this.oApp.exec("RECORD_UNDO_ACTION", ["BEFORE SET CONTENTS", {
                sSaveTarget: "BODY"
            }])
        },
        ...
        $AFTER_SET_IR: function(e, t) {
            t = t || !1, t || this.oApp.exec("RECORD_UNDO_ACTION", ["AFTER SET CONTENTS", {
                sSaveTarget: "BODY"
            }])
        },
        $ON_REGISTER_EDITING_AREA: function(e) {
            this.oEditingMode[e.sMode] = e, "WYSIWYG" == e.sMode && this.attachDocumentEvents(e.oEditingArea), this._setEditingAreaDimension(e)
        },
        ...
        $ON_RESIZE_EDITING_AREA: function(e, t) {
            null !== e && "undefined" != typeof e && this._resizeWidth(e, "px"), null !== t && "undefined" != typeof t && this._resizeHeight(t, "px"), this._setEditingAreaDimension()
        },
        ...
        $ON_MSG_EDITING_AREA_RESIZE_ENDED: function(e, t, i) {
        ...
        $ON_KEEP_WITHIN_EDITINGAREA: function(e, t) {
            ...
            i + e.offsetHeight > this.oApp.elEditingAreaContainer.offsetHeight && ("number" == typeof t ? e.style.top = i - e.offsetHeight - t + "px" : e.style.top = this.oApp.elEditingAreaContainer.offsetHeight - e.offsetHeight + "px");
            var n = parseInt(e.style.left, 10);
            n + e.offsetWidth > this.oApp.elEditingAreaContainer.offsetWidth && (e.style.left = this.oApp.elEditingAreaContainer.offsetWidth - e.offsetWidth + "px")
        },
        ...
        _convertLastBrToNbsp: function() {
            var e, t, i, n, o, s, r, a, l, h, d, c, _, p, E = this.oApp.getWYSIWYGDocument().body,
                u = document.createTextNode(" ");
            e = jindo.$$("br:last-child", E, {
                oneTimeOffCache: !0
            });
            for (var g = 0, f = e.length; f > g; g++)
                if (a = null, p = null, t = e[g], n = this._findNextSiblingRecursive(t, {
                        isReverse: !0
                    }), n && 1 === n.nodeType && (i = n.nextSibling, s = this._findNextSiblingRecursive(i), !s)) {
                    if ("IMG" === n.tagName.toUpperCase() ? a = n : (r = jindo.$$("img:last-child", n, {
                            oneTimeOffCache: !0
                        }), r.length > 0 && (a = r[r.length - 1])), a)
                        if (o = this._findNextSiblingRecursive(a), o == i) {
                            if (h = a.parentNode, !h) continue;
                            l = jindo.$Element(a).width(), h = a.parentNode, d = jindo.$Element(h).width(), c = !(l === d)
                        } else c = !0;
                    else c = !0;
                    p = t.parentNode, c ? (_ = u.cloneNode(!1),
                        p.replaceChild(_, t)) : this._recursiveRemoveChild(t)
                }
        },
        _findNextSiblingRecursive: function(e, t) {
            for (var i, n = e, o = t && t.isReverse ? !0 : !1, s = (new RegExp("^(P|DIV)$", "i"), new RegExp("^(TD|BODY)$", "i")); !i;)
        ...
        _recursiveRemoveChild: function(e) {
            var t, i = e.parentNode,
                n = e;
            do i.removeChild(n); while ((t = i.childNodes) && 0 == t.length && (n = i) && (i = i.parentNode))
        },
...
nhn.husky.SE_EditingAreaManager.version = {
        ...
        $init: function(e) {
            ...
            t.ie && (this.iframe.style.display = "none"), this.sBlankPageURL = "smart_editor2_inputarea.html", this.sBlankPageURL_EmulateIE7 = "smart_editor2_inputarea_ie8.html", this.aAddtionalEmulateIE7 = [], this.htOptions = nhn.husky.SE2M_Configuration.SE_EditingAreaManager, this.htOptions && (this.sBlankPageURL = this.htOptions.sBlankPageURL || this.sBlankPageURL, this.sBlankPageURL_EmulateIE7 = this.htOptions.sBlankPageURL_EmulateIE7 || this.sBlankPageURL_EmulateIE7, this.aAddtionalEmulateIE7 = this.htOptions.aAddtionalEmulateIE7 || this.aAddtionalEmulateIE7), this.aAddtionalEmulateIE7.push(8), this.sIFrameSrc = this.sBlankPageURL, t.ie && jindo.$A(this.aAddtionalEmulateIE7).has(t.nativeVersion) && (this.sIFrameSrc = this.sBlankPageURL_EmulateIE7);
            ...
            !t.ie || t.version >= 9 && document.addEventListener ? (e.addEventListener("load", n, !1), e.addEventListener("error", o, !1)) : (e.attachEvent("onload", n), e.attachEvent("onerror", o)), e.src = i, this.elEditingArea = e
        },
        $BEFORE_MSG_APP_READY: function() {
        ...
        $ON_MSG_APP_READY: function() {
            this.oApp.hasOwnProperty("saveSnapShot") || (this.$ON_EVENT_EDITING_AREA_MOUSEUP = function() {}, this._recordUndo = function() {}), this._bIERangeReset = !0, this.oApp.oNavigator.ie || navigator.userAgent.indexOf("Edge") > -1 ? (this._bIECursorHide = !0, jindo.$Fn(function(e) {
            ...
            }, this).attach(this.iframe.contentWindow.document, "keydown"), jindo.$Fn(function(e) {
                this._oIERange = null, this._bIERangeReset = !0
            }, this).attach(this.iframe.contentWindow.document.body, "mousedown"), this.getDocument().createRange || jindo.$Fn(this._onIEBeforeDeactivate, this).attach(this.iframe.contentWindow.document.body, "beforedeactivate"), jindo.$Fn(function(e) {
        ...
        $AFTER_EVENT_EDITING_AREA_KEYUP: function(e) {
            if (this.bAutoResize) {
                var t = e.key();
                t.keyCode >= 33 && t.keyCode <= 40 || t.alt || t.ctrl || 16 === t.keyCode || this._setAutoResize()
            }
        },
        ...
        _setBodyHeight: function() {
            if (!this.bStopCheckingBodyHeight) {
                ...
                h && d || n.css("height", "0px"), e = parseInt(i.scrollHeight, 10), t = e > s ? e - o : r, this._isHorizontalScrollbarVisible() && (t -= this.nScrollbarWidth), h && d || n.css("height", t + "px"), this.nBodyHeight_last = t, setTimeout(this.fnSetBodyHeight, 500)
            }
        },
        _isHorizontalScrollbarVisible: function() {
            var e = this.getDocument();
            return e.documentElement.clientWidth < e.documentElement.scrollWidth ? !0 : !1
        },
        ...
        _onIEBeforeDeactivate: function(e) {
        ...
        $ON_CHANGE_EDITING_MODE: function(e, t) {
            if (e === this.sMode) {
                var i = jindo.$Agent().navigator();
                if (i.ie && i.nativeVersion > 8) {
        ...
        $ON_IE_HIDE_CURSOR: function() {
            if (this._bIECursorHide) {
                ...
                if (e && e.createRange) try {
                    ...
                    e = this.oApp.getSelection(), e.select(), e.oBrowserSelection.selectNone()
        ...
        $BEFORE_EVENT_EDITING_AREA_KEYDOWN: function(e) {
            this._bKeyDown = !0
        },
        ...
        _delete: function(e) {
            ...
            if (t)
                ...
                var i = this.oApp.getSelection().getLineInfo(),
                    n = i.oEnd.oLineBreaker,
                    o = n && n.nextSibling;
                this._removeWrongSpan(o)
        ...
        $BEFORE_EVENT_EDITING_AREA_KEYUP: function(e) {
            return this._bKeyDown ? void(this._bKeyDown = !1) : !1
        },
        ...
        _scrollIntoView: function(e) {
            var t = this._getElementVerticalPosition(e),
                i = this._getVisibleVerticalPosition(),
                n = 0;
            if (!this._isElementVisible(t, i)) return (n = t.nBottom - i.nBottom) > 0 ? void this.getWindow().scrollTo(0, i.nTop + n) : void this.getWindow().scrollTo(0, t.nTop)
        },
        ...
        $AFTER_MSG_EDITING_AREA_RESIZE_ENDED: function(e, t, i) {
            if (this.oApp.getEditingMode() === this.sMode && !jindo.$Agent().navigator().ie) {
                var n = this.oApp.getEmptySelection();
                n.moveToBookmark(this.sBM), n.select(), n.removeStringBookmark(this.sBM)
            }
        },
        ...
        _replaceBlankToNbsp: function(e) {
            ...
            if (t.ie && 9 === t.nativeVersion && 7 === document.documentMode && 1 === e.nodeType && "BR" !== e.tagName) {
                ...
                jindo.$A(i).forEach(function(e, t, i) {
                    e.innerHTML = "&nbsp;"
                })
            }
        },
        ...
        getIR: function() {
            var e, t = this.iframe.contentWindow.document.body.innerHTML;
            return e = this.oApp.applyConverter ? this.oApp.applyConverter(this.sMode + "_TO_IR", t, this.oApp.getWYSIWYGDocument()) : t
        },
        setIR: function(e) {
            var t, i = this.oApp.oNavigator,
                n = i.ie && document.documentMode < 11,
                o = n ? "" : "";
            if (t = this.oApp.applyConverter ? this.oApp.applyConverter("IR_TO_" + this.sMode, e, this.oApp.getWYSIWYGDocument()) : e, "" === t.replace(/[\r\n\t\s]*/, "") && ("BR" !== this.oApp.sLineBreaker && (o = "<p>" + o + "</p>"), t = o), this.iframe.contentWindow.document.body.innerHTML = t, n && this.oApp.getEditingMode() === this.sMode)
                for (var s = this.oApp.getWYSIWYGDocument().body.getElementsByTagName("P"), r = 0, a = s.length; a > r; r++) 1 === s[r].childNodes.length && "&nbsp;" === s[r].innerHTML && (s[r].innerHTML = "")
        },
        getRawContents: function() {
        ...
        _recordUndo: function(e) {
            return e.keyCode >= 33 && e.keyCode <= 40 ? void this.oApp.saveSnapShot() : void(e.alt || e.ctrl || 16 === e.keyCode || this.oApp.getLastKey() !== e.keyCode && (this.oApp.setLastKey(e.keyCode), (e.enter || 46 === e.keyCode || 8 === e.keyCode) && this.oApp.exec("RECORD_UNDO_ACTION", ["KEYPRESS(" + e.keyCode + ")", {
        ...
        $AFTER_CHANGE_EDITING_MODE: function(e, t) {
            if (e == this.sMode && !t) {
                var i = new TextRange(this.elEditingArea);
                i.setSelection(0, 0)
            }
        },
        startAutoResize: function() {
        ...
        setRawContents: function(e) {
            "undefined" != typeof e && (this.elEditingArea.value = e)
        },
        getRawContents: function() {
        ...
        var i = this._o;
        if ("undefined" == typeof t && (t = e), i.setSelectionRange) i.setSelectionRange(e, t);
        ...
        this.setSelection(i[0] + e.length - r)
        ...
        irToText: function(e) {
            var t = e,
                i = 0,
                n = t.match(new RegExp(this.sRxConverter));
            return null !== n && (t = t.replace(new RegExp(this.sRxConverter), "")), t = t.replace(/\r/g, ""), t = t.replace(/[\n|\t]/g, ""), t = t.replace(/[\v|\f]/g, ""), t = t.replace(/<p><br><\/p>/gi, "\n"), t = t.replace(/<P>&nbsp;<\/P>/gi, "\n"), t = t.replace(/<br(\s)*\/?>/gi, "\n"), t = t.replace(/<br(\s[^\/]*)?>/gi, "\n"), t = t.replace(/<\/p(\s[^\/]*)?>/gi, "\n"), t = t.replace(/<\/li(\s[^\/]*)?>/gi, "\n"), t = t.replace(/<\/tr(\s[^\/]*)?>/gi, "\n"), i = t.lastIndexOf("\n"), i > -1 && "\n" == t.substring(i) && (t = t.substring(0, i)), t = jindo.$S(t).stripTags().toString(), t = this.unhtmlSpecialChars(t), null !== n && (t = n[0] + t), t
        },
        textToIr: function(e) {
            if (e) {
                var t = e,
                    i = null;
                return i = t.match(new RegExp(this.sRxConverter)), null !== i && (t = t.replace(i[0], "")), t = this.htmlSpecialChars(t), t = this._addLineBreaker(t), null !== i && (t = i[0] + t), t
            }
        },
        _addLineBreaker: function(e) {
            if ("BR" === this.oApp.sLineBreaker) return e.replace(/\r?\n/g, "<BR>");
            for (var t = new StringBuffer, i = e.split("\n"), n = i.length, o = "", s = 0; n > s && (o = jindo.$S(i[s]).trim().$value(), s !== n - 1 || "" !== o); s++) null !== o && "" !== o ? (t.append("<P>"), t.append(i[s]), t.append("</P>")) : jindo.$Agent().navigator().ie ? t.append("") : t.append("");
            return t.toString()
        },
        startAutoResize: function() {
            var e = {
        ...
        $init: function(e) {
            "BR" == e ? this.sLineBreaker = "BR" : this.sLineBreaker = "P", this.htBrowser = jindo.$Agent().navigator(), this.htBrowser.opera && "P" == this.sLineBreaker && (this.$ON_MSG_APP_READY = function() {}), this.htBrowser.ie ? this._addCursorHolder = this._addCursorHolderSpace : (this._addExtraCursorHolder = function() {}, this._addBlankText = function() {})
        },
        $ON_MSG_APP_READY: function() {
        ...
        _addBlankText: function(e) {
            ...
            for (t = 0, i = r.length; i > t; t++) n = r[t], 1 === n.nodeType && "SPAN" === n.tagName && (n.id.indexOf(e.HUSKY_BOOMARK_START_ID_PREFIX) > -1 || n.id.indexOf(e.HUSKY_BOOMARK_END_ID_PREFIX) > -1 || (o = n.firstChild,
                (!o || 3 == o.nodeType && nhn.husky.SE2M_Utils.isBlankTextNode(o) || 1 == o.nodeType && 1 == n.childNodes.length && (o.id.indexOf(e.HUSKY_BOOMARK_START_ID_PREFIX) > -1 || o.id.indexOf(e.HUSKY_BOOMARK_END_ID_PREFIX) > -1)) && (s = e._document.createTextNode(unescape("%uFEFF")), n.appendChild(s))))
        },
        _addCursorHolder: function(e) {
            var t = e;
            return ("" == e.innerHTML || (t = this._getStyleOnlyNode(e))) && (t.innerHTML = "<br>"), t || (t = this._getStyleNode(e)), t
        },
        _addCursorHolderSpace: function(e) {
            var t;
            if (this._addSpace(e), t = this._getStyleNode(e), "" == t.innerHTML && "param" != t.nodeName.toLowerCase()) try {
        ...
        _convertHeadSpace: function(e) {
            if (e && 3 === e.nodeType) {
                for (var t, i = e.nodeValue, n = "", o = 0;
                    (t = i[o]) && " " === t; o++) n += " ";
                o > 0 && (e.nodeValue = n + i.substring(o))
            }
        },
        ...
        _wrapBlock: function(e) {
            ...
            if ((!a.bParentBreak || o.rxBlockContainer.test(a.oLineBreaker.tagName)) && (e.stop(), o.deleteContents(), a.oNode.parentNode && 11 !== a.oNode.parentNode.nodeType)) {
                ...
                return h === a.oNode && (h = l.oNode), o.setEndAfter(h), this._addBlankText(o), o.surroundContents(i), o.moveToStringBookmark(s, !0), o.collapseToEnd(), o.removeStringBookmark(s), o.select(), this._addCursorHolder(t), null !== i.lastChild && "BR" == i.lastChild.tagName && i.removeChild(i.lastChild), n = this._addCursorHolder(i), i.nextSibling && "BR" == i.nextSibling.tagName && i.parentNode.removeChild(i.nextSibling), o.selectNodeContents(n), o.collapseToStart(), o.select(), this.oApp.exec("CHECK_STYLE_CHANGE"), s = o.placeStringBookmark(), void setTimeout(jindo.$Fn(function(e) {
                    var t = o.getStringBookmark(e);
                    t && (o.moveToStringBookmark(e), o.select(), o.removeStringBookmark(e))
                }, this).bind(s), 0)
            }
            ...
            if (this.htBrowser.firefox) d && d.nextSibling && "IFRAME" == d.nextSibling.tagName ? setTimeout(jindo.$Fn(function(e) {
                ...
                var c = d.parentNode,
                    _ = !1,
                    p = !1;
                if (this._firstBR2Line(c, o, l.oLineBreaker), !d || !c) return void o.removeStringBookmark(s);
                if (setTimeout(jindo.$Fn(function() {
                        this.oApp.getSelection().removeStringBookmark(s)
                    }, this).bind(s), 0), _ = "U" === c.tagName || null !== nhn.husky.SE2M_Utils.findAncestorByTagName("U", c), p = "S" === c.tagName || "STRIKE" === c.tagName || null !== nhn.husky.SE2M_Utils.findAncestorByTagName("S", c) && null !== nhn.husky.SE2M_Utils.findAncestorByTagName("STRIKE", c), _ || p) return void setTimeout(jindo.$Fn(this._addTextDecorationTag, this).bind(_, p), 0);
                setTimeout(jindo.$Fn(this._addExtraCursorHolder, this).bind(c), 0)
            } else {
                var c = d.parentNode,
                    E = this._getValidNextSibling(d);
                if ("SPAN" == c.tagName && E && "BR" == E.nodeName && E.nextSibling) {
                    o.deleteContents(), o.setEndNodes(d, l.oLineBreaker);
                    var u = o.extractContents(),
                        g = u.firstChild;
                    c = a.oLineBreaker.parentNode, E = a.oLineBreaker.nextSibling, E ? c.insertBefore(u, E) : c.appendChild(u), o.selectNodeContents(g), o.collapseToStart(), o.select(), o.removeStringBookmark(s), e.stop()
        ...
        _addExtraCursorHolder: function(e) {
            var t, i, n;
            if (e = this._getStyleOnlyNode(e), e && "SPAN" === e.tagName) {
                for (t = e.lastChild; t;) i = t.previousSibling, 3 === t.nodeType ? (nhn.husky.SE2M_Utils.isBlankTextNode(t) && t.parentNode.removeChild(t), t = i) : t = i;
                n = e.innerHTML, "" === n.replace("​", "").replace("\ufeff", "") && (e.innerHTML = "​")
            }
            var o, s = this.oApp.getSelection();
            s.collapsed && (s.fixCommonAncestorContainer(), o = s.commonAncestorContainer, o && (o = s._getVeryFirstRealChild(o), 3 === o.nodeType && (o = o.parentNode), o && "SPAN" === o.tagName && (n = o.innerHTML, "" === n.replace("​", "").replace("\ufeff", "") && (o.innerHTML = "​"), s.selectNodeContents(o), s.collapseToStart(), s.select())))
        },
        _addSpace: function(e) {
            ...
            if (e) {
                ...
                if (s = jindo.$Element(e).child(function(e) {
                        return 1 === e.$value().nodeType && "IMG" === e.$value().tagName
                    }, 1), s.length > 0) {
                    for (r = s[s.length - 1].$value(), i = r.nextSibling; i;) n = i.nextSibling, 3 !== i.nodeType || "&nbsp;" !== i.nodeValue && i.nodeValue !== unescape("%u00A0") && "​" !== i.nodeValue || e.removeChild(i), i = n;
                    return e
                }
                for (i = e.firstChild, n = i, o = !1; i;) n = i.nextSibling, 3 === i.nodeType && (i.nodeValue === unescape("%uFEFF") && e.removeChild(i), o || "&nbsp;" !== i.nodeValue && i.nodeValue !== unescape("%u00A0") && "​" !== i.nodeValue || (o = !0)), i = n;
        ...
        _getStyleOnlyNode: function(e) {
            ...
            for (; e.firstChild && this.oSelection._isBlankTextNode(e.firstChild);) e.removeChild(e.firstChild);
            return e.childNodes.length > 1 ? null : e.firstChild ? 3 === e.firstChild.nodeType ? nhn.husky.SE2M_Utils.isBlankTextNode(e.firstChild) ? e : null : this._getStyleOnlyNode(e.firstChild) : e
        },
        _insertBR: function(e) {
            ...
            if (t.insertNode(i), t.selectNode(i), t.collapseToEnd(), !this.htBrowser.ie) {
                var n = t.getLineInfo(),
                    o = n.oEnd;
                if (o.bParentBreak) {
                    for (; o.oNode && 3 == o.oNode.nodeType && "" == o.oNode.nodeValue;) o.oNode = o.oNode.previousSibling;
                    var s = 1;
                    (o.oNode == i || o.oNode.nextSibling == i) && (s = 0), 0 === s && (t.pasteHTML("<br type='_moz'/>"), t.collapseToEnd())
                }
            }
        ...
        isUseModeChanger: function() {
            return "undefined" == typeof this.htConversionMode || "undefined" == typeof this.htConversionMode.bUseModeChanger || this.htConversionMode.bUseModeChanger === !0 ? !0 : !1
        },
        $ON_EVENT_CHANGE_EDITING_MODE_CLICKED: function(e, t) {
            if ("TEXT" == e) {
                var i = this.oApp.getIR();
                if (i.length > 0 && !t && !confirm(this.oApp.$MSG("SE2M_EditingModeChanger.confirmTextMode"))) return !1;
        ...
        _extractStyle: function(e) {
            if (e) {
                var t = e.match(this._rxStyleTag) || [],
                    i = t.join("\n");
                i = i.replace(this._rxStyleTagStrip, "");
                var n = this._getTmpDocument(),
                    o = n.getElementsByTagName("HEAD")[0],
                    s = n.createElement("STYLE");
                s.innerHTML = i, o.appendChild(s), this._htStyleRule = this._getCSSStyleRule(s.sheet.cssRules), s.parentNode.removeChild(s)
            }
        },
        _applyInlineStyle: function(e, t, i) {
            for (var n, o = 0, s = t.length; s > o; o++) n = t[o], (i || !e.style[n]) && (e.style[n] = t[n])
        },
        ...
        $BEFORE_EXECCOMMAND: function(e, t, i, n) {
            var o;
            this.oApp.exec("FOCUS"), this._bOnlyCursorChanged = !1, o = this.oApp.getSelection();
            for (var s, r = 0, a = o.getNodes(); s = a[r]; r++) nhn.husky.SE2M_Utils.removeInvalidNodeInTable(s);
            /^insertorderedlist|insertunorderedlist$/i.test(e) && (this._getDocumentBR(), this._checkBlockQuoteCondition_IE()), /^justify*/i.test(e) && this._removeElementAlign("span"), this._rxCmdInline.test(e) && (this.oUndoOption = {
                bMustBlockElement: !0
            }, nhn.CurrentSelection.isCollapsed() && (this._bOnlyCursorChanged = !0)), ("indent" == e || "outdent" == e) && (n || (n = {}), n.bDontAddUndoHistory = !0), n && n.bDontAddUndoHistory || this._bOnlyCursorChanged || (/^justify*/i.test(e) ? this.oUndoOption = {
                sSaveTarget: "BODY"
            } : ("insertorderedlist" === e || "insertunorderedlist" === e) && (this.oUndoOption = {
                bMustBlockContainer: !0
            }), this.oApp.exec("RECORD_UNDO_BEFORE_ACTION", [e, this.oUndoOption])), this.oNavigator.ie && this.oApp.getWYSIWYGDocument().selection && "Control" === this.oApp.getWYSIWYGDocument().selection.type && (o = this.oApp.getSelection(), o.select()), ("insertorderedlist" == e || "insertunorderedlist" == e) && this._insertBlankLine()
        },
        _checkBlockQuoteCondition_IE: function() {
            var e, t = jindo.$Agent().navigator(),
                i = !1;
            if (t.ie && t.nativeVersion >= 9 && t.nativeVersion <= 11 && t.version >= 9 && t.version <= 11 || this.oApp.oAgent.os().winxp && t.ie && t.nativeVersion <= 8 || t.edge) {
                var n = this.oApp.getSelection(),
                    o = n.commonAncestorContainer,
                    s = nhn.husky.SE2M_Utils.findAncestorByTagNameWithCount("BLOCKQUOTE", o);
                if (e = s.elNode) {
                    var r = nhn.husky.SE2M_Utils.findClosestAncestorAmongTagNamesWithCount(["td", "th"], o);
                    r.elNode ? r.nRecursiveCount > s.nRecursiveCount && (i = !0) : i = !0
                }
            }
            ...
            if (t = "" == t || t ? t : !1, i = "" == i || i ? i : !1, this.oApp.exec("IS_SELECTED_TD_BLOCK", ["bIsSelectedTd", o]), n = o.bIsSelectedTd) "indent" == e ? this.oApp.exec("SET_LINE_BLOCK_STYLE", [null, jindo.$Fn(this._indentMargin, this).bind()]) : "outdent" == e ? this.oApp.exec("SET_LINE_BLOCK_STYLE", [null, jindo.$Fn(this._outdentMargin, this).bind()]) : this._setBlockExecCommand(e, t, i);
                ...
                case "outdent":
                    ...
                    "indent" === e ? this.oApp.exec("SET_LINE_STYLE", [null, jindo.$Fn(this._indentMargin, this).bind(), {
                        ...
                        bDoNotSelect: !0,
                        bDontAddUndoHistory: !0
                    }]), s.moveToStringBookmark(r), s.select(), s.removeStringBookmark(r), setTimeout(jindo.$Fn(function(e) {
                ...
                case "justifyright":
                case "justifyfull":
                    var a = this._extendBlock();
                    this.oEditingArea.execCommand(e, t, i), a && a.select(), this.oNavigator.ie && this._removeElementAlign("table");
                    break;
                default:
                    if (s.collapsed && this._rxCmdInline.test(e)) {
                        var l = s.placeStringBookmark(),
                            h = s.getStringBookmark(l),
                            d = h.previousSibling;
                        d && "​" === d.nodeValue || (d = this.oApp.getWYSIWYGDocument().createTextNode("​"), s.insertNode(d)), s.removeStringBookmark(l), s.selectNodeContents(d), s.select(), this.oEditingArea.execCommand(e, t, i), s.collapseToEnd(), s.select();
                        var c = this._findSingleNode(d);
                        c && s._hasCursorHolderOnly(c.nextSibling) && c.parentNode.removeChild(c.nextSibling)
        ...
        _removeElementAlign: function(e) {
            for (var t = this.oApp.getSelection(), i = t.getNodes(), n = null, o = new RegExp("^" + e + "$", "i"), s = 0, r = i.length; r > s; s++) n = i[s], n.tagName && o.test(n.tagName) && (n.style.textAlign = "", n.removeAttribute("align"))
        },
        ...
        _fixAlign: function(e) {
            var t = this.oApp.getSelection(),
                ...
                n = null,
                o = null;
            this.oNavigator.ie ? function(e) {
                return e.tagName && "TABLE" === e.tagName ? (e.removeAttribute("align"), !0) : !1
            } : function() {};
            t.collapsed ? i[0] = t.startContainer : i = t.getNodes();
            for (var s = 0, r = i.length; r > s; s++) n = i[s], 3 === n.nodeType && (n = n.parentNode), (!o || n !== o && !jindo.$Element(n).isChildOf(o)) && (o = this._getAlignNode(n), o && o.align !== o.style.textAlign && (o.style.textAlign = e, o.setAttribute("align", e)))
        },
        _getDocumentBR: function() {
            var e, t;
            for (this.aBRs = this.oApp.getWYSIWYGDocument().getElementsByTagName("BR"), this.aBeforeBRs = [], e = 0, t = this.aBRs.length; t > e; e++) this.aBeforeBRs[e] = this.aBRs[e]
        },
        _fixDocumentBR: function() {
            if (this.aBeforeBRs.length !== this.aBRs.length) {
                var e, t = jindo.$A(this.aBeforeBRs),
                    i = this.aBRs.length;
                for (e = i - 1; e >= 0; e--) t.indexOf(this.aBRs[e]) < 0 && this.aBRs[e].parentNode.removeChild(this.aBRs[e])
            }
        },
        ...
        _indentMargin: function(e) {
            ...
            if ("LI" === e.tagName) {
                if (e.previousSibling && e.previousSibling.tagName && e.previousSibling.tagName === e.parentNode.tagName) {
                    if (e.nextSibling && e.nextSibling.tagName && e.nextSibling.tagName === e.parentNode.tagName) {
                        for (t = [e], i = 0, n = e.nextSibling.childNodes.length; n > i; i++) t.push(e.nextSibling.childNodes[i]);
                        for (o = e.previousSibling, s = e.nextSibling, i = 0, n = t.length; n > i; i++) o.insertBefore(t[i], null);
            ...
            r = parseInt(e.style.marginLeft, 10), r || (r = 0), r += this.nIndentSpacing, e.style.marginLeft = r + "px"
        },
        _outdentMargin: function(e) {
            ...
            if ("LI" !== e.tagName) r = parseInt(e.style.marginLeft, 10), r || (r = 0), r -= this.nIndentSpacing, 0 > r && (r = 0), e.style.marginLeft = r + "px";
            else {
                ...
                if (t.parentNode.insertBefore(e, i), t.innerHTML.match(/LI/i) || t.parentNode.removeChild(t), !e.parentNode.tagName.match(/OL|UL/)) {
                    for (o = e.parentNode, i = e, s = this.oApp.getWYSIWYGDocument(), o = s.createElement("P"), i = null, e.parentNode.insertBefore(o, e); e.firstChild;) o.insertBefore(e.firstChild, i);
        ...
        _insertBlankLine: function() {
            ...
            if (!this.elP1 && !this.elP2) {
                t = e.commonAncestorContainer, t = 1 !== t.nodeType ? t.parentNode : t;
        ...
        _fixCorruptedBlockQuote: function(e) {
            ...
            for (s = 0, r = d.length; r > s; s++)
                ...
                for (i = t.parentNode, a = this._getPosIdx(t), l = this.oApp.getWYSIWYGDocument().createElement("DIV"), l.innerHTML = t.outerHTML.replace("<" + e, "<BLOCKQUOTE"), t.parentNode.insertBefore(l.firstChild, t), t.parentNode.removeChild(t), n = i.childNodes[a], o = n.getElementsByTagName(e), s = 0, r = o.length; r > s; s++) o[s].childNodes.length < 1 && o[s].parentNode.removeChild(o[s]);
                h = this.oApp.getEmptySelection(), h.selectNodeContents(n), h.collapseToEnd(), h.select()
            }
        },
        _removeBlockQuote: function() {
            for (var e, t, i, n = "Apple-style-span", o = this.oApp.getSelection(), s = o.commonAncestorContainer, r = s; s;) "LI" === s.tagName ? (i = s, s = "display: inline !important; " === s.style.cssText ? s.parentNode : null) : "SPAN" === s.tagName && s.className === n ? (e = s, s = i ? null : s.parentNode) : s = s.parentNode;
            for (i && e && (s = e.parentNode, s.replaceChild(r, e), o.selectNodeContents(s), o.collapseToEnd(), o.select()); s;)
        ...
        _extendBlock: function() {
            var e = this.oApp.getSelection(),
                ...
                o = [],
                s = e.cloneRange();
            if (t === i && 1 === t.nodeType && "P" === t.tagName && (n = jindo.$A(t.childNodes).filter(function(e, t, i) {
                    return 1 === e.nodeType && "IMG" === e.tagName
                }).$value(), o = jindo.$A(e.getNodes()).filter(function(e, t, i) {
                    return 1 === e.nodeType && "IMG" === e.tagName
                }).$value(), !(n.length <= o.length))) return e.selectNode(t), e.select(), s
        }
        ...
        $init: function() {
            var e = jindo.$Agent().navigator();
            e.ie && e.version > 8 && (this._sCursorHolder = "⁠", this.$ON_REGISTER_CONVERTERS = function() {
                var e = /\u2060/g;
                this.oApp.exec("ADD_CONVERTER", ["WYSIWYG_TO_IR", jindo.$Fn(function(t) {
                    return t.replace(e, "\ufeff")
                }, this).bind()])
            })
        },
        $PRECONDITION: function(e, t) {
        ...
        $ON_SET_WYSIWYG_STYLE: function(e) {
            ...
            if (t.collapsed && !n) {
                ...
                3 == r.nodeType && (r = r.parentNode), r && t._rxCursorHolder.test(r.innerHTML) && (o = t._findParentSingleSpan(r)), o ? "" == o.innerHTML && (o.innerHTML = this._sCursorHolder) : (o = this.oApp.getWYSIWYGDocument().createElement("SPAN"), o.innerHTML = this._sCursorHolder, s = !0);
                var a;
                for (var l in e) a = e[l], "string" == typeof a && (o.style[l] = a);
                if (s)
                    if ("BODY" == t.startContainer.tagName && 0 === t.startOffset) {
                        var h = t._getVeryFirstRealChild(this.oApp.getWYSIWYGDocument().body),
                            ...
                            c = h.cloneNode(!1);
                        try {
                            c.innerHTML = "test", "test" != c.innerHTML && (d = !1)
                        } catch (_) {
                            d = !1
                        }
                ...
                return e.color && t._checkTextDecoration(o), t.selectNodeContents(s ? o : r), t.collapseToEnd(), t._window.focus(), t._window.document.body.focus(), void t.select()
            }
            if (this.oApp.exec("RECORD_UNDO_BEFORE_ACTION", ["FONT STYLE", {
                ...
                for (var E = 0; E < p.length; E++) t.selectNodeContents(p[E]), t.styleRange(e), t.select()
            } else {
                for (var u, g = !!e.color, f = e.fontSize || e.fontFamily, A = 0, p = t.getNodes(); u = p[A]; A++) nhn.husky.SE2M_Utils.removeInvalidNodeInTable(u);
                if (t.styleRange(e, null, null, f, g), jindo.$Agent().navigator().firefox)
                    for (var S = t.aStyleParents, A = 0, T = S.length; T > A; A++) {
                        var C = S[A];
                        C.nextSibling && "BR" == C.nextSibling.tagName && !C.nextSibling.nextSibling && C.parentNode.removeChild(C.nextSibling)
                    }
        ...
        $ON_EVENT_EDITING_AREA_KEYPRESS: function(e) {
            var t;
            if (!this.oApp.oNavigator.firefox || (t = e.key(), !t.ctrl || 97 != t.keyCode)) return this.bAllSelected ? void(this.bAllSelected = !1) : void this.oApp.exec("CHECK_STYLE_CHANGE")
        },
        $ON_EVENT_EDITING_AREA_KEYDOWN: function(e) {
            var t = e.key();
            ...
            if (8 == t.keyCode || t.keyCode >= 33 && t.keyCode <= 40 || 45 == t.keyCode || 46 == t.keyCode) {
                ...
                if (this.bAllSelected) {
                    ...
                    return void(this.bAllSelected = !1)
                }
                this.oApp.exec("CHECK_STYLE_CHANGE")
            }
        },
        ...
        $ON_RESET_STYLE_STATUS: function() {
            ...
            this.oStyle.fontFamily = e.fontFamily, this.oStyle.fontSize = e.fontSize, this.oStyle.justifyleft = "@^";
            for (var t in this.oStyle) this.oApp.exec("MSG_STYLE_CHANGED", [t, this.oStyle[t]])
        },
        ...
        _getStyle: function() {
            ...
            if (nhn.CurrentSelection.isCollapsed()) e = this._getStyleOf(nhn.CurrentSelection.getCommonAncestorContainer());
                ...
                var t = this.oApp.getSelection(),
                    i = function(e) {
                        return e.childNodes && 0 != e.childNodes.length ? !1 : !0
                    },
                    n = t.getNodes(!1, i);
                e = 0 == n.length ? this._getStyleOf(t.commonAncestorContainer) : this._getStyleOf(n[0])
            }
            for (attributeName in e)
                if (this.oStyleMap[attributeName].converter && (e[attributeName] = this.oStyleMap[attributeName].converter(e[attributeName], e)), this.oStyle[attributeName] != e[attributeName]) {
                    if ("object" != typeof document.body.currentStyle && "function" == typeof getComputedStyle && "fontSize" == attributeName && this.oStyle.fontFamily != e.fontFamily) continue;
                    this.oApp.exec("MSG_STYLE_CHANGED", [attributeName, e[attributeName]])
                } this.oStyle = e
        },
        _getStyleOf: function(e) {
            ...
            for (var o in this.oStyle)
                if (i = this.oStyleMap[o], i.type && "Value" == i.type) try {
                    if (i.css) {
                        var s = n.css(i.css);
        ...
        _assignHTMLElements: function(e) {
            this.oDropdownLayer = jindo.$$.getSingle("DIV.husky_se_fontSize_layer", e), this.elFontSizeLabel = jindo.$$.getSingle("SPAN.husky_se2m_current_fontSize", e), this.aLIFontSizes = jindo.$A(jindo.$$("LI", this.oDropdownLayer)).filter(function(e, t, i) {
        ...
        $ON_MSG_STYLE_CHANGED: function(e, t) {
            if ("fontSize" == e) {
                if (this._rxPX.test(t)) {
                    ...
                    t = i > 0 ? 72 * i / 96 + "pt" : this.sDefaultText
                }
                if (this._rxPT.test(t)) {
                    var i = parseFloat(t.replace(this._rxPT, "")),
                        n = Math.floor(i),
                        o = i - n;
                    i = o >= 0 && .25 > o ? n + 0 : o >= .25 && .75 > o ? n + .5 : n + 1, t = i + "pt"
                }
        ...
        _clearFontSizeSelection: function(e) {
            for (var t = 0; t < this.aLIFontSizes.length; t++) jindo.$Element(this.aLIFontSizes[t]).removeClass("active")
        }
        ...
        getLineStyle: function(e) {
            var t, i, n, o, s = this._getSelectedNodes(!1);
            if (0 === s.length) return null;
            var r = s.length;
            0 === r ? o = null : (i = this._getLineWrapper(s[0]), o = this._getWrapperLineStyle(e, i));
            var a = this.oSelection.getStartNode();
            if (null != o)
                for (var l = 1; r > l; l++)
                    if (!this._isChildOf(s[l], t) && s[l] && (t = this._getLineWrapper(s[l]), t != i)) {
                        if (n = this._getWrapperLineStyle(e, t), n != o) {
                            o = null;
                            break
                        }
                        i = t
                    } t = this._getLineWrapper(s[r - 1]);
            var h = this.oSelection.getEndNode();
        ...
        setLineStyle: function(e, t, i, n) {
            function o(e, t, i) {
                if (!e) {
                    r = !0;
                    try {
                        e = thisRef.oSelection.surroundContentsWithNewNode("P")
                    } catch (n) {
                        e = thisRef.oSelection.surroundContentsWithNewNode("DIV")
                    }
                }
            ...
            if (0 !== n.length) {
                var a, l, h = n.length;
                i && i.bDontAddUndoHistory || this.oApp.exec("RECORD_UNDO_BEFORE_ACTION", ["LINE STYLE"]), l = this._getLineWrapper(n[0]), l = o(l, e, t);
                for (var d = l, c = l, _ = 1; h > _; _++) {
                    try {
                        if (!s(nhn.DOMFix.parentNode(n[_]))) continue
                    } catch (p) {
                        continue
                    }
                    this._isChildOf(n[_], a) || (a = this._getLineWrapper(n[_]), a != l && (a = o(a, e, t), l = a))
                }
                c = a || d, !r || i && i.bDoNotSelect || setTimeout(jindo.$Fn(function(e, t, i) {
        ...
        getTextNodes: function(e, t) {
            var i = function(e) {
                return 3 == e.nodeType && "\n" != e.nodeValue && "" != e.nodeValue && "\ufeff" != e.nodeValue || "LI" == e.tagName && "" == e.innerHTML || "P" == e.tagName && "" == e.innerHTML ? !0 : !1
            };
            return t.getNodes(e, i)
        },
        _getSelectedNodes: function(e) {
            if (e || (this.oSelection = this.oApp.getSelection()), "LI" == this.oSelection.endContainer.tagName && 0 == this.oSelection.endOffset && "" == this.oSelection.endContainer.innerHTML && this.oSelection.setEndAfter(this.oSelection.endContainer), this.oSelection.collapsed) {
                ...
                if (t.length > 0) return [t[0].firstChild, t[t.length - 1].lastChild];
        ...
        $ON_COLOR_PALETTE_APPLY_COLOR: function(e, t) {
            t = t ? t : !1, e = this._getHexColorCode(e), this.bUseRecentColor && t && this.oApp.exec("ADD_RECENT_COLOR", [e]), this.oApp.exec(this.sCallbackCmd, [e])
        },
        ...
        _addRecentColor: function(e) {
            ...
            t = t.refuse(e), t.unshift(e), t.length() > this.nLimitRecentColor && t.length(this.nLimitRecentColor), this.aRecentColor = t.$value()
        },
        _redrawRecentColorElement: function() {
            var e, t = [],
                i = this.aRecentColor.length;
            if (0 !== i) {
                for (e = 0; i > e; e++) t.push(this.sRecentColorTemp.replace(/\{RGB_CODE\}/gi, this.aRecentColor[e]));
        ...
        _ajaxRecentColorCallback: function(e) {
            ...
            if (o && !o.error) {
                for (t = jindo.$A(o).filter(this._verifyColorCode, this), t.length() > this.nLimitRecentColor && t.length(this.nLimitRecentColor), o = t.reverse().$value(), i = 0, n = o.length; n > i; i++) this._addRecentColor(this._getHexColorCode(o[i]));
                this._redrawRecentColorElement()
            }
        }
    }).extend(jindo.Component), nhn.husky.SE2M_FontColor = jindo.$Class({
        name: "SE2M_FontColor",
        rxColorPattern: /^#?[0-9a-fA-F]{6}$|^rgb\(\d+, ?\d+, ?\d+\)$/i,
        $init: function(e) {
            this._assignHTMLElements(e)
        ...
        _generateAutoLink: function(e, t, i, n, o) {
            t = t || "";
            var s;
            return s = n ? '<a href="http://' + n + '">' + i + "</a>" : '<a href="' + o + '">' + i + "</a>", t + s
        },
        $BEFORE_MSG_APP_READY: function() {
        ...
        $LOCAL_BEFORE_FIRST: function(e) {
            return e.match(/(REGISTER_CONVERTERS)/) ? (this.oApp.acceptLocalBeforeFirstAgain(this, !0), !0) : (this._assignHTMLElements(this.oApp.htOptions.elAppContainer), this.sRXATagMarker = this.sATagMarker.replace(/\//g, "\\/").replace(/\./g, "\\."), this.oApp.registerBrowserEvent(this.oBtnConfirm, "click", "APPLY_HYPERLINK"), this.oApp.registerBrowserEvent(this.oBtnCancel, "click", "HIDE_ACTIVE_LAYER"), void this.oApp.registerBrowserEvent(this.oLinkInput, "keydown", "EVENT_HYPERLINK_KEYDOWN"))
        },
        ...
        irToDb: function(e) {
            if (!this._bDisabled) {
                ...
                for (var n, o, s = this.oApp.getEmptySelection(), r = s._getFirstRealChild(t), a = s._getLastRealChild(t), l = jindo.$A(s._getNodesBetween(r, a)), h = l.filter(function(e) {
                        return e && 3 === e.nodeType
                    }).$value(), d = h, c = h, _ = this.oApp.getWYSIWYGDocument().createElement("DIV"), p = "@" + (new Date).getTime() + "@", E = new RegExp(p, "g"), u = 0, g = h.length; g > u; u++) {
                    for (n = d[u].parentNode, o = !1; n;) {
                        if ("A" === n.tagName || "PRE" === n.tagName) {
                            o = !0;
                            break
                        }
                        n = n.parentNode
                    ...
                    if (!o) {
                        _.innerHTML = "";
                        try {
                            _.appendChild(d[u].cloneNode(!0)), _.innerHTML = (p + _.innerHTML).replace(/(&nbsp|\s)?(((?!http[s]?:\/\/)www\.(?:(?!\&nbsp;|\s|"|').)+)|(http[s]?:\/\/(?:(?!&nbsp;|\s|"|').)+))/gi, this._generateAutoLink), d[u].parentNode.insertBefore(_, d[u]), d[u].parentNode.removeChild(d[u])
                        } catch (f) {}
                        for (; _.firstChild;) _.parentNode.insertBefore(_.firstChild, _);
                        _.parentNode.removeChild(_)
                    }
                }
                _ = s = r = a = l = h = d = c = n = null, t.innerHTML = t.innerHTML.replace(E, ""), e.innerHTML = t.innerHTML, t = null
            }
        }
        ...
        addAllFonts: function() {
            ...
            if (this.htOptions && this.htOptions.aDefaultFontList && 0 !== this.htOptions.aDefaultFontList.length || (this.addFont("돋움,Dotum", "돋움", 0, "", "", 1, null, !0), this.addFont("돋움체,DotumChe,AppleGothic", "돋움체", 0, "", "", 1, null, !0), this.addFont("굴림,Gulim", "굴림", 0, "", "", 1, null, !0), this.addFont("굴림체,GulimChe", "굴림체", 0, "", "", 1, null, !0), this.addFont("바탕,Batang,AppleMyungjo", "바탕", 0, "", "", 1, null, !0), this.addFont("바탕체,BatangChe", "바탕체", 0, "", "", 1, null, !0), this.addFont("궁서,Gungsuh,GungSeo", "궁서", 0, "", "", 1, null, !0), this.addFont("Arial", "Arial", 0, "", "", 1, "abcd", !0), this.addFont("Tahoma", "Tahoma", 0, "", "", 1, "abcd", !0), this.addFont("Times New Roman", "Times New Roman", 0, "", "", 1, "abcd", !0), this.addFont("Verdana", "Verdana", 0, "", "", 1, "abcd", !0), this.addFont("Courier New", "Courier New", 0, "", "", 1, "abcd", !0)), this.aAdditionalFontList && this.aAdditionalFontList.length > 0)
                for (o = 0, nLen = this.aAdditionalFontList.length; o < nLen; o++) this.addFont(this.aAdditionalFontList[o][0], this.aAdditionalFontList[o][1], 0, "", "", 1)
        },
        $ON_MSG_APP_READY: function() {
        ...
        _assignHTMLElements: function(e) {
            this.oDropdownLayer = jindo.$$.getSingle("DIV.husky_se_fontName_layer", e), this.elFontNameLabel = jindo.$$.getSingle("SPAN.husky_se2m_current_fontName", e), this.elFontNameList = jindo.$$.getSingle("UL", this.oDropdownLayer), this.elInnerLayer = this.elFontNameList.parentNode, this.aelFontInMarkup = jindo.$$("LI", this.oDropdownLayer), this.elFontItemTemplate = this.aelFontInMarkup.shift(), this.aLIFontNames = jindo.$A(jindo.$$("LI", this.oDropdownLayer)).filter(function(e, t, i) {
                return null !== e.firstChild
        ...
        _initFontName: function() {
            ...
            var e;
            this.oApp.getCurrentStyle && (e = this.oApp.getCurrentStyle()) && this.$ON_MSG_STYLE_CHANGED("fontFamily", e.fontFamily), this.oApp.registerBrowserEvent(this.oDropdownLayer, "mouseover", "EVENT_FONTNAME_LAYER_MOUSEOVER", []), this.oApp.registerBrowserEvent(this.oDropdownLayer, "click", "EVENT_FONTNAME_LAYER_CLICKED", [])
        },
        _checkFontLI: function(e, t) {
            if (!e) return !1;
            var i = IsInstalledFont(t);
            return e.style.display = i ? "block" : "none", i
        },
        _addFontInMarkup: function() {
            for (var e, t, i, n, o = 0; e = this.aelFontInMarkup[o]; o++) e.firstChild ? (t = this._getFontFamilyFromLI(e).replace(this._rxQuote, "").replace(this._rxComma, ","), n |= this._checkFontLI(e, t)) : e.className.indexOf(this.FONT_SEPARATOR) > -1 ? (i && (i.style.display = n ? "block" : "none"), i = e, n = !1) : e.style.display = "none";
        ...
        _onMouseupCover: function(e) {
            ...
            if (o.selectNode(i), o.collapseToStart(), o.select(), n.fireEvent("mousedown", {
                ...
                if ("<p></p>" == this.oApp.getWYSIWYGDocument().body.innerHTML) {
                    ...
                    var o = this.oApp.getSelection();
                    o.moveToStringBookmark("INIT"), o.select(), o.removeStringBookmark("INIT")
                }
        ...
        _loadAllBaseFont: function() {
            ...
            if (this.htBrowser.ie) {
                if (this.htBrowser.nativeVersion < 9)
                    for (e = 0, t = this.aBaseFontList.length; t > e; e++) this.aBaseFontList[e].loadCSS(this.oApp.getWYSIWYGDocument());
                else if (document.documentMode < 9)
                    for (e = 0, t = this.aBaseFontList.length; t > e; e++) this.aBaseFontList[e].loadCSSToMenu();
        ...
        _findLI: function(e) {
            ...
            return e.className.indexOf(this.FONT_SEPARATOR) > -1 ? null : e
        },
        ...
        $ON_SET_FONTFAMILY: function(e, t) {
            if (e) {
                ...
                i && i.loadCSS(this.oApp.getWYSIWYGDocument()), this.oApp.exec("RECORD_UNDO_BEFORE_ACTION", ["SET FONTFAMILY", {
                        bMustBlockElement: !0
                    }]), this.bDoNotRecordUndo = !0, parseInt(t, 10) > 0 && this.oApp.exec("SET_WYSIWYG_STYLE", [{
                        fontSize: t
        ...
        _getMatchingLI: function(e) {
            e = e.toLowerCase();
            for (var t, i, n = 0; n < this.aLIFontNames.length; n++) {
        ...
        setDefaultFont: function(e, t) {
            ...
            i.style.fontFamily = e, t > 0 && (i.style.fontSize = t + "pt")
        }
    }), nhn.husky.SE2M_FontNameWithLayerUI.CUSTOM_FONT_MARKS = "'", nhn.ColorPicker = jindo.$Class({
        elem: null,
        huePanel: null,
        canvasType: "Canvas",
        _hsvColor: null,
        $init: function(e, t) {
            ...
            }), this.option(t), this.option("huePanel") && (this.huePanel = jindo.$Element(this.option("huePanel")).empty()), this._hsvColor = this._hsv(0, 100, 100);
            for (var i in this) /^_on[A-Z][a-z]+[A-Z][a-z]+$/.test(i) && (this[i + "Fn"] = jindo.$Fn(this[i], this));
        ...
        hsv: function(e) {
            if ("undefined" == typeof e) return this._hsvColor;
            var t = null,
                i = this.elem.width(),
                n = this.elem.height(),
                o = this.cursor.width(),
            ...
            if (this.huePanel) t = this._hsv2rgb(e.h, 100, 100), this.elem.css("background", "#" + this._rgb2hex(t.r, t.g, t.b)), r = e.s / 100 * i, a = (100 - e.v) / 100 * n;
                ...
                var l = i / 2;
                e.v > e.s ? (e.v = 100, r = e.s / 100 * l) : (e.s = 100, r = (100 - e.v) / 100 * l + l), a = e.h / 360 * n
            }
        ...
        _paintColWithCanvas: function() {
            ...
            var t = e.attr("width", e.width()).attr("height", e.height()).$value().getContext("2d"),
                ...
                n = e.width(),
                o = e.height();
            i = t.createLinearGradient(0, 0, n, 0), i.addColorStop(0, "rgba(255,255,255,1)"), i.addColorStop(1, "rgba(255,255,255,0)"), t.fillStyle = i, t.fillRect(0, 0, n, o), i = t.createLinearGradient(0, 0, 0, o), i.addColorStop(0, "rgba(0,0,0,0)"), i.addColorStop(1, "rgba(0,0,0,1)"), t.fillStyle = i, t.fillRect(0, 0, n, o)
        },
        _paintOneWithFilter: function() {
            for (var e, t, i, n, o, s, r = this.elem.height(), a = 1; 7 > a; a++) e = Math.floor((a - 1) / 6 * r), t = Math.floor(a / 6 * r), i = this._hsv2rgb((a - 1) / 6 * 360, 100, 100), n = this._hsv2rgb(a / 6 * 360, 100, 100), o = "#FF" + this._rgb2hex(i.r, i.g, i.b), s = "#FF" + this._rgb2hex(n.r, n.g, n.b), jindo.$Element("<div>").css({
                position: "absolute",
                left: 0,
                width: "100%",
                top: e + "px",
        ...
        _paintOneWithCanvas: function() {
            ...
            for (var i = t.attr("width", t.width()).attr("height", t.height()).$value().getContext("2d"), n = t.width(), o = t.height(), s = i.createLinearGradient(0, 0, 0, o), r = 0; 7 > r; r++) e = this._hsv2rgb(r / 6 * 360, 100, 100), s.addColorStop(r / 6, "rgb(" + e.join(",") + ")");
            i.fillStyle = s, i.fillRect(0, 0, n, o), s = i.createLinearGradient(0, 0, n, 0), s.addColorStop(0, "rgba(255,255,255,1)"), s.addColorStop(.5, "rgba(255,255,255,0)"), s.addColorStop(.5, "rgba(0,0,0,0)"), s.addColorStop(1, "rgba(0,0,0,1)"), i.fillStyle = s, i.fillRect(0, 0, n, o)
        },
        _paintHueWithFilter: function() {
            ...
            isNaN(d) && (d = 0), a -= 2 * d;
            for (var c = 1; 7 > c; c++) {
                e = Math.floor((c - 1) / 6 * (r ? l : a)), t = Math.floor(c / 6 * (r ? l : a)), i = this._hsv2rgb((c - 1) / 6 * 360, 100, 100), n = this._hsv2rgb(c / 6 * 360, 100, 100), o = "#FF" + this._rgb2hex(i.r, i.g, i.b), s = "#FF" + this._rgb2hex(n.r, n.g, n.b), h = jindo.$Element("<div>").css({
                    position: "absolute",
                    filter: "progid:DXImageTransform.Microsoft.Gradient(GradientType=" + (r ? 0 : 1) + ",StartColorStr='" + o + "',EndColorStr='" + s + "')"
                });
                var _ = t - e + 1;
                h.appendTo(this.huePanel), h.css(r ? "left" : "top", 0).css(r ? "width" : "height", "100%"), h.css(r ? "top" : "left", e + "px").css(r ? "height" : "width", _ + "px")
            }
        },
        _paintHueWithCanvas: function() {
            var e, t = this.option(),
                i = "vertical" == t.huePanelType,
                n = jindo.$Element("<canvas>").css({
                    width: "100%",
                    height: "100%"
                });
            n.appendTo(this.huePanel.empty());
            for (var o = n.attr("width", n.width()).attr("height", n.height()).$value().getContext("2d"), s = o.createLinearGradient(0, 0, i ? 0 : n.width(), i ? n.height() : 0), r = 0; 7 > r; r++) e = this._hsv2rgb(r / 6 * 360, 100, 100), s.addColorStop(r / 6, "rgb(" + e.join(",") + ")");
            o.fillStyle = s, o.fillRect(0, 0, n.width(), n.height())
        },
        _rgb2hsv: function(e, t, i) {
            var n = 0,
                ...
                r = Math.min(e, t, i),
                a = s - r;
            return o = s ? a / s : 0, o && (e == s ? n = 60 * (t - i) / a : t == s ? n = 120 + 60 * (i - e) / a : i == s && (n = 240 + 60 * (e - t) / a), 0 > n && (n += 360)), n = Math.floor(n), o = Math.floor(100 * o), s = Math.floor(s / 255 * 100), this._hsv(n, o, s)
        },
        ...
        _rgb2hex: function(e, t, i) {
            return e = e.toString(16), 1 == e.length && (e = "0" + e), t = t.toString(16), 1 == t.length && (t = "0" + t), i = i.toString(16), 1 == i.length && (i = "0" + i), e + t + i
        },
        _hex2rgb: function(e) {
        ...
        _onMoveColor: function(e) {
            ...
            if (n = Math.max(Math.min(n, s), 0), o = Math.max(Math.min(o, r), 0), this.huePanel) t.s = t[1] = n / s * 100, t.v = t[2] = (r - o) / r * 100;
                ...
                t.h = o / r * 360;
                var a = s / 2;
                a > n ? (t.s = n / a * 100, t.v = 100) : (t.s = 100, t.v = (s - n) / a * 100)
            }
            this.hsv(t), e.stop()
        },
        ...
        _onMoveHue: function(e) {
            ...
            "vertical" == this.option().huePanelType ? (n = r, o = this.huePanel.height()) : (n = s, o = this.huePanel.width()), t.h = t[0] = Math.min(Math.max(n, 0), o) / o * 360 % 360, this.hsv(t), e.stop()
        }
    }).extend(jindo.Component), nhn.husky.SE2M_Accessibility = jindo.$Class({
        ...
        $LOCAL_BEFORE_FIRST: function(e) {
            ...
            var t = this.oApp.getWYSIWYGWindow().frameElement;
            this.htOffsetPos = jindo.$Element(t).offset(), this.nEditorWidth = t.offsetWidth, this.htInitialPos = this.welHelpPopupLayer.offset();
            this.oApp.oUtils.getScrollXY();
            this.nLayerWidth = 590, this.nLayerHeight = 480, this.htTopLeftCorner = {
        ...
        _findNextFocusElement: function(e) {
            for (var t = null, i = e.nextSibling; i;) {
                ...
                if (i = this._switchToSiblingOrNothing(i), !i) break
            }
            return t
        },
        ...
        _recursivePreorderTraversalFilter: function(e, t, i) {
            var n = this,
                o = t.apply(e);
            if (o) return n._bStopFindingNextElement = !0, void(i ? n._previousFocusElement = e : n._nextFocusElement = e);
            if (i)
                for (var s = e.childNodes.length, r = s - 1; r >= 0 && (n._recursivePreorderTraversalFilter(e.childNodes[r], t, !0), !this._bStopFindingNextElement); r--);
            else
                for (var r = 0, s = e.childNodes.length; s > r && (n._recursivePreorderTraversalFilter(e.childNodes[r], t), !this._bStopFindingNextElement); r++);
        },
        _isFocusTag: function() {
            for (var e = this, t = ["A", "BUTTON", "INPUT", "TEXTAREA"], i = !1, n = 0, o = t.length; o > n; n++)
        ...
        _findPreviousFocusElement: function(e) {
            for (var t = null, i = e.previousSibling; i;) {
                ...
                if (i = this._switchToSiblingOrNothing(i, !0), !i) break
            }
            return t
        },
        ...
        $ON_REGISTER_CONVERTERS: function() {
            this.oApp.exec("ADD_CONVERTER", ["DB_TO_IR", jindo.$Fn(function(e) {
                ...
                var t = this.htQuoteStyles_view;
                return e = e.replace(/<(blockquote)[^>]*class=['"]?(se2_quote[0-9]+)['"]?[^>]*>/gi, function(e, i, n) {
                    return "<" + i + " class=" + n + ' style="' + t[n] + '">'
                })
        ...
        $ON_EVENT_EDITING_AREA_KEYDOWN: function(e) {
            var t, i;
            "WYSIWYG" === this.oApp.getEditingMode() && 8 === e.key().keyCode && (t = this.oApp.getSelection(), t.fixCommonAncestorContainer(), i = this._findParentQuote(t.commonAncestorContainer), i && this._isBlankQuote(i) && (e.stop(jindo.$Event.CANCEL_DEFAULT), t.selectNode(i), t.collapseToStart(), jindo.$Element(i).leave(), t.select()))
        },
        $ON_EVENT_EDITING_AREA_KEYUP: function(e) {
            var t, i, n;
            if ("WYSIWYG" === this.oApp.getEditingMode() && 46 === e.key().keyCode) return t = this.oApp.getSelection(), t.fixCommonAncestorContainer(), (i = this._findParentQuote(t.commonAncestorContainer)) ? void(i.nextSibling || (e.stop(jindo.$Event.CANCEL_DEFAULT), n = t._document.createElement("P"), n.innerHTML = "&nbsp;", jindo.$Element(i).after(n), setTimeout(jindo.$Fn(function(e) {
                var t = e.placeStringBookmark();
                e.select(), e.removeStringBookmark(t)
            }, this).bind(t), 0))) : !1
        },
        _isBlankQuote: function(e) {
            var t, i, n, o, s = this.oApp.oNavigator.chrome,
                r = this.oApp.oNavigator.safari,
                a = function(e) {
                    return e = e.replace(/[\r\n]/gi, "").replace(unescape("%uFEFF"), ""), "" === e ? !0 : "&nbsp;" === e || " " === e ? !0 : !1
                },
                l = function(e) {
                    return 3 === e.nodeType && a(e.nodeValue) ? !0 : "P" !== e.tagName && "SPAN" !== e.tagName || !a(e.innerHTML) && "<br>" !== e.innerHTML ? !1 : !0
                },
                h = function(e) {
                    return 0 === jindo.$$("tr", e).length ? !0 : !1
                };
            if (a(e.innerHTML) || "<br>" === e.innerHTML) return !0;
            if (s || r) {
                var d, c = jindo.$$("TABLE", e),
                    _ = c.length;
                for (n = 0; _ > n; n++) d = c[n], h(d) && jindo.$Element(d).leave()
            }
            for (i = e.childNodes, n = 0, o = i.length; o > n; n++)
                if (t = i[n], !l(t)) return !1;
            return !0
        },
        _findParentQuote: function(e) {
            return this._findAncestor(jindo.$Fn(function(e) {
                ...
                var t = e.className;
                return this.htQuoteStyles_view[t] ? !0 : !1
            }, this).bind(), e)
        },
        ...
        irToDbDOM: function(e) {
            ...
            if (jindo.$A(i).forEach(function(e, i, n) {
                    jindo.$Element(e).attr("attr_no_border_tbl") && t.push(e)
                }, this), !(t.length < 1))
                for (var n, o = [], s = 0, r = t.length; r > s; s++) n = t[s], jindo.$Element(n).css({
                    border: "",
                    borderLeft: "",
                    borderBottom: ""
                    ...
                    border: 0,
                    cellpadding: 1
                }), o = jindo.$$("tbody>tr>td", n), jindo.$A(o).forEach(function(e, t, i) {
                    jindo.$Element(e).css({
                        border: "",
                        borderTop: "",
                        borderRight: ""
        ...
        $ON_IS_SELECTED_TD_BLOCK: function(e, t) {
            return this.nSelectedTD > 0 ? (t[e] = !0, t[e]) : (t[e] = !1, t[e])
        },
        ...
        $ON_DELETE_BLOCK_CONTENTS: function() {
            var e, t, i, n = this;
            this.setTdBlock();
            for (var o = 0; o < this.nSelectedTD; o++) jindo.$Element(this.htSelectedTD.aTdCells[o]).child(function(o) {
                e = jindo.$Element(o._element.parentNode), e.remove(o), t = n.oDocument.createElement("P"), i = jindo.$Agent().navigator().firefox ? n.oDocument.createElement("BR") : n.oDocument.createTextNode(" "), t.appendChild(i), e.append(t)
            }, 1)
        }
        ...
        $ON_CHOOSE_REMOVE_STYLE: function(e) {
            var t = !1,
                i = {};
            this.oApp.exec("IS_SELECTED_TD_BLOCK", ["bIsSelectedTd", i]), t = i.bIsSelectedTd, this.oApp.exec("RECORD_UNDO_BEFORE_ACTION", ["REMOVE STYLE", {
                bMustBlockElement: !0
            }]), t ? this.oApp.exec("REMOVE_STYLE_IN_BLOCK", []) : this.oApp.exec("REMOVE_STYLE", []), this.oApp.exec("RECORD_UNDO_AFTER_ACTION", ["REMOVE STYLE", {
                bMustBlockElement: !0
            }]), this.oApp.exec("MSG_NOTIFY_CLICKCR", ["noeffect"])
        },
        $ON_REMOVE_STYLE_IN_BLOCK: function(e) {
            var t = {};
            this.oSelection = this.oApp.getSelection(), this.oApp.exec("GET_SELECTED_TD_BLOCK", ["aTdCells", t]);
            for (var i = t.aTdCells, n = 0; n < i.length; n++) this.oSelection.selectNodeContents(i[n]), this.oSelection.select(), this.oApp.exec("REMOVE_STYLE", [])
        },
        $ON_REMOVE_STYLE: function(e) {
            if (e && e.commonAncestorContainer || (e = this.oApp.getSelection()), !e.collapsed) {
                ...
                var t = e.placeStringBookmark(),
                    i = e.getNodes(!0);
                this._removeStyle(i), e.moveToBookmark(t);
                for (var i = e.getNodes(!0), n = 0; n < i.length; n++) {
                    var o = i[n];
                    o.style && "BR" != o.tagName && "TD" != o.tagName && "TR" != o.tagName && "TBODY" != o.tagName && "TABLE" != o.tagName && (o.removeAttribute("align"), o.removeAttribute("style"), "inline" != jindo.$Element(o).css("display") || "IMG" == o.tagName || "IFRAME" == o.tagName || o.firstChild && !e._isBlankTextNode(o.firstChild) || o.parentNode.removeChild(o))
                }
                e.moveToBookmark(t), "TBODY" === e.commonAncestorContainer.tagName && (e = this.oApp.getSelection()), e.select();
                for (var s = this._document.getElementById(e.HUSKY_BOOMARK_START_ID_PREFIX + t); s;) {
                    for (oParent = nhn.DOMFix.parentNode(s), oParent.removeChild(s); oParent && (!oParent.firstChild || !oParent.firstChild.nextSibling && e._isBlankTextNode(oParent.firstChild));) {
                        var r = oParent.parentNode;
                        oParent.parentNode.removeChild(oParent), oParent = r
                    }
                    s = this._document.getElementById(e.HUSKY_BOOMARK_START_ID_PREFIX + t)
                }
                for (var s = this._document.getElementById(e.HUSKY_BOOMARK_END_ID_PREFIX + t); s;) {
                    for (oParent = nhn.DOMFix.parentNode(s), oParent.removeChild(s); oParent && (!oParent.firstChild || !oParent.firstChild.nextSibling && e._isBlankTextNode(oParent.firstChild));) {
                        var r = oParent.parentNode;
                        oParent.parentNode.removeChild(oParent), oParent = r
                    }
                    s = this._document.getElementById(e.HUSKY_BOOMARK_END_ID_PREFIX + t)
                }
                this.oApp.exec("CHECK_STYLE_CHANGE")
            }
        },
                ...
                if (n && n.parentNode && n.parentNode.tagName) {
                    ...
                    if ("inline" == jindo.$Element(n.parentNode).css("display")) {
                        ...
                        if (n.nextSibling) {
                            if (-1 == t.indexOf(this._getVeryLast(n.nextSibling)))
                                if (i--, -1 != t.indexOf(this._getVeryFirst(n.parentNode))) {
                                    for (var r = n, a = s; r;) {
                                        ...
                                        if (s.parentNode.insertBefore(r, a), a = r, !l) break;
                                        r = l
                                    }
                                    0 === s.childNodes.length && s.parentNode.removeChild(s)
                                } else {
                                    if (o) {
                                        i++;
                                        continue
                                    }
                                    var h = this._document.createElement("SPAN"),
                                        r = n;
                                    for (s.insertBefore(h, r.nextSibling); r;) {
                                        var l = r.previousSibling;
                                        if (h.insertBefore(r, h.firstChild), !l) break;
                                        if (-1 == t.indexOf(this._getVeryFirst(l))) break;
                                        r = l
                                    }
                                    for (this._splitAndAppendAtTop(h); h.firstChild;) h.parentNode.insertBefore(h.firstChild, h);
                            ...
                            for (var r = n; r;) {
                                var l = r.previousSibling;
                                if (s.parentNode.insertBefore(r, s.nextSibling), !l) break;
                                if (-1 == t.indexOf(this._getVeryFirst(l))) break;
                                r = l
                            }
                            0 === s.childNodes.length && s.parentNode.removeChild(s)
        ...
        _splitAndAppendAtTop: function(e) {
            ...
            oTop = i.parentNode, oTop.insertBefore(t, i.nextSibling), oTop.insertBefore(n, t.nextSibling)
        },
            ...
            this.oApp.exec("ADD_CONVERTER_DOM", ["WYSIWYG_TO_IR", jindo.$Fn(function(e) {
                if (!(this.aSelectedCells.length < 1))
                    for (var t, i = ["TD", "TH"], n = 0; n < i.length; n++) {
                        t = e.getElementsByTagName(i[n]);
                        for (var o = 0, s = t.length; s > o; o++) t[o].className && (t[o].className = t[o].className.replace(this.CELL_SELECTION_CLASS, ""), t[o].getAttribute(this.TMP_BGC_ATTR) ? (t[o].style.backgroundColor = t[o].getAttribute(this.TMP_BGC_ATTR), t[o].removeAttribute(this.TMP_BGC_ATTR)) : t[o].getAttribute(this.TMP_BGIMG_ATTR) && (jindo.$Element(this.aCells[o]).css("backgroundImage", t[o].getAttribute(this.TMP_BGIMG_ATTR)), t[o].removeAttribute(this.TMP_BGIMG_ATTR)))
                    }
            }, this).bind()])
        },
        $ON_MSG_APP_READY: function() {
        ...
        getData: function() {
            var e = this;
            jindo.$Ajax(e._sBaseAjaxUrl, {
                type: "jsonp",
                timeout: 1,
                onload: function(t) {
                    var i = t.json().result;
                    i && i.text_data ? e.setData(i.text_data) : e.setData("{table:'full',img:'full',review:'full'}")
                },
                onerror: function() {
        ...
        searchId: function(e, t) {
            var i = !1;
            if (jindo.$H(this.datas).forEach(function(n, o) {
                    t == n.element && (e = o, i = !0, jindo.$H.Break())
                }), !i && e in this.datas) {
                for (var n = e; n in this.datas;) n = "nonID" + (new Date).getTime();
                return n
            }
            return e
        },
        set: function(e, t, i) {
            ...
            var n = this.get(e);
            this.datas[e] = n ? n.createKey(t) : new Shortcut.Data(e, t, i)
        },
        get: function(e, t) {
        ...
        reset: function(e) {
            var t = this.datas[e];
            Shortcut.Helper.bind(t.func, t.element, "detach"), delete this.datas[e]
        },
        allReset: function() {
        ...
        $init: function(e, t, i) {
            this.id = e, this.element = i, this.func = jindo.$Fn(this.fire, this).bind(), Shortcut.Helper.bind(this.func, i, "attach"), this.keys = {}, this.keyStemp = {}, this.createKey(t)
        },
        createKey: function(e) {
            this.keyStemp[Shortcut.Helper.keyInterpretor(e)] = e, this.keys[e] = {};
            var t = this.keys[e];
        ...
        excute: function(e, t) {
            var i = !0,
                n = Shortcut.Helper,
                o = this.keys[t];
            n.notCommonException(e, o.commonExceptions) && jindo.$A(o.events).forEach(function(t) {
                if (o.stopDefalutBehavior) {
                    var n = t.exceptions.length;
                    if (n) {
                        for (var s = 0; n > s; s++)
                            if (!t.exception[s](e)) {
                                i = !1;
                            ...
                            if (t.event(e), jindo.$Agent().navigator().ie) {
                                var r = e._event;
                                r.keyCode = "", r.charCode = ""
                            }
                            e.stop()
                        } else jindo.$A.Break()
                    } else {
        ...
        addEvent: function(e, t) {
            ...
            Shortcut.Helper.hasEvent(e, i) || i.push({
                event: e,
                exceptions: []
            })
        },
        addException: function(e, t) {
            ...
            Shortcut.Helper.hasException(e, i) || i.push(e)
        },
        removeException: function(e, t) {
            var i = this.keys[t].commonExceptions;
            i = jindo.$A(i).filter(function(t) {
                return t != e
            }).$value()
        },
        removeEvent: function(e, t) {
            ...
            i = jindo.$A(i).filter(function(t) {
                return t != e
            }).$value(), this.unRegister(t)
        },
        unRegister: function(e) {
            var t = this.keys[e].events;
            t.length && delete this.keys[e];
            var i = !0;
            for (var n in this.keys) {
                i = !1;
                break
            }
            i && (Shortcut.Helper.bind(this.func, this.element, "detach"), delete Shortcut.Store.datas[this.id])
        },
        ...
        keyInterpretor: function(e) {
            ...
            var i = i.filter(function(e) {
                ...
                o = i.$value()[0];
            if (o) {
                var e = Shortcut.Store.anthorKeyHash[o.toUpperCase()] || o.toUpperCase().charCodeAt(0);
                n += e
            }
            return n
        },
        ...
        bind: function(e, t, i) {
            "attach" == i ? domAttach(t, "keydown", e) : domDetach(t, "keydown", e)
        }
    },
    function() {
    ...
    function() {
        ...
        resetElement: function() {
            return Shortcut.Store.reset(this.dataInstance.id), this
        },
        resetAll: function() {
            return Shortcut.Store.allReset(), this
        }
    },
    function() {
        ...
        for (var e = Shortcut.Store.anthorKeyHash, t = 1; 13 > t; t++) Shortcut.Store.anthorKeyHash["F" + t] = t + 111;
        var i = jindo.$Agent().navigator();
...
nhn.husky.Hotkey = jindo.$Class({
        ...
        $ON_UNDO: function() {
            if (this._doRecordUndoHistory("UNDO", {
                ...
                if (e && this.oApp.exec(e.sMsg, e.aParams), this.oCurStateIdx.nStep > 0) this.oCurStateIdx.nStep--;
                else {
                    var i = this.aUndoHistory[this.oCurStateIdx.nIdx];
                    this.oCurStateIdx.nIdx--, i.nTotalSteps > 1 ? this.oCurStateIdx.nStep = 0 : (i = this.aUndoHistory[this.oCurStateIdx.nIdx], this.oCurStateIdx.nStep = i.nTotalSteps - 1)
                }
        ...
        $ON_RECORD_UNDO_ACTION: function(e, t) {
            ...
            }, t.nStep = 0, t.bSkipIfEqual = !1, t.bTwoStepAction = !1, this._doRecordUndoHistory(e, t)
        },
        $ON_RECORD_UNDO_BEFORE_ACTION: function(e, t) {
            t = t || {
                ...
                bMustBlockContainer: !1,
                bDontSaveSelection: !1
            }, t.nStep = 0, t.bSkipIfEqual = !1, t.bTwoStepAction = !0, this._doRecordUndoHistory(e, t)
        },
        $ON_RECORD_UNDO_AFTER_ACTION: function(e, t) {
            t = t || {
                ...
                bMustBlockContainer: !1,
                bDontSaveSelection: !1
            }, t.nStep = 1, t.bSkipIfEqual = !1, t.bTwoStepAction = !0, this._doRecordUndoHistory(e, t)
        },
        $ON_RESTORE_UNDO_HISTORY: function(e, t, i) {
            ...
            if (this.oApp.exec("RESTORE_IE_SELECTION"), i) this.oApp.getWYSIWYGDocument().body.innerHTML = s, s = this.oApp.getWYSIWYGDocument().body.innerHTML, h = s, a = this.sDefaultXPath;
            else {
                l = d._evaluateXPath(a, d._document);
                try {
                    l.innerHTML = o, h = l.innerHTML
                } catch (c) {
                    this.oApp.getWYSIWYGDocument().body.innerHTML = s, s = this.oApp.getWYSIWYGDocument().body.innerHTML, h = s, a = this.sDefaultXPath
                }
            }
            ...
            }, this).bind(), 0) : (d = this.oApp.getEmptySelection(), d.selectionLoaded && (r ? d.moveToXPathBookmark(r) : d = this.oApp.getEmptySelection(), d.select()))
        },
        _doRecordUndoHistory: function(e, t) {
            ...
            if (A = this.oApp.getSelection(), A.selectionLoaded && (f = A.getXPathBookmark()), g = r ? A._getXPath(r) : s ? this._getTargetXPath(f, s) : this._getParentXPath(f, l, h), u = this.oApp.getWYSIWYGDocument().body.innerHTML, E = g === this.sDefaultXPath ? u : A._evaluateXPath(g, A._document).innerHTML, this.bFF && E == this.sBlankContentsForFF && (E = ""), !o && n) {
                if (p.length === u.length) return;
                var T = document.createElement("div"),
                    C = document.createElement("div");
                T.innerHTML = u, C.innerHTML = p;
                var m = document.createDocumentFragment();
                if (m.appendChild(T), m.appendChild(C), u = T.innerHTML, p = C.innerHTML, T = null, C = null, m = null, p.length === u.length) return
            }
            a && (f = {
                sType: "scroll",
        ...
        _getTargetXPath: function(e, t) {
            var i = this.sDefaultXPath,
                ...
                l = -1;
            if ("BODY" === t) return i;
            for (a = 0; r > a && n[a] === o[a]; a++) s.push(n[a]), "" !== n[a] && "HTML" !== n[a] && "BODY" !== n[a] && n[a].indexOf(t) > -1 && (l = a);
            return l > -1 && (s.length = l), i = s.join("/"), i.length < this.sDefaultXPath.length && (i = this.sDefaultXPath), i
        },
        _getParentXPath: function(e, t, i) {
            ...
            if (n = e[0].sXPath.split("/"), o = e[1].sXPath.split("/"), s = this.oSnapShot.oBookmark[0].sXPath.split("/"), r = this.oSnapShot.oBookmark[1].sXPath.split("/"), a = s.length < r.length ? s.length : r.length, l = n.length < o.length ? n.length : o.length, l = a > l ? l : a, 3 > l) return c;
            for (t = t || !1, i = i || !1, p = 3; l > p && (h = n[p], h === o[p] && h === s[p] && h === r[p] && o[p] === s[p] && o[p] === r[p] && s[p] === r[p]); p++) _.push(h), d = h.substring(0, h.indexOf("[")), !t || "P" !== d && "LI" !== d && "DIV" !== d ? ("UL" === d || "OL" === d || "TD" === d || "TR" === d || "TABLE" === d || "BLOCKQUOTE" === d) && (E = p) : E = p;
            if (E > -1) _.length = E + 1;
        ...
        $ON_SHOW_ACTIVE_LAYER: function(e, t, i) {
            e = jindo.$(e);
            var n = this.oCurrentLayer;
            e != n && (this.oApp.exec("HIDE_ACTIVE_LAYER", []), this.sOnCloseCmd = t, this.aOnCloseParam = i, e.style.display = "block", this.oCurrentLayer = e, this.oApp.exec("ADD_APP_PROPERTY", ["oToolBarLayer", this.oCurrentLayer]))
        },
        ...
        applyConverter: function(e, t, i) {
            ...
            i = i || document, this.oApp.exec("MSG_STRING_CONVERTER_STARTED", [e, s]);
            var r;
            if (t = s.sContents, r = this.oConverters_DOM[e]) {
                var a = i.createElement("DIV");
                a.innerHTML = t;
                for (var l = 0; l < r.length; l++) r[l](a);
                t = a.innerHTML, a.parentNode && a.parentNode.removeChild(a), a = null, jindo.$Agent().navigator().ie && (n += "(\r\n)?", o = new RegExp(n, "g"))
            }
            if (r = this.oConverters[e])
                for (var l = 0; l < r.length; l++) {
                    var h = r[l](t);
                    "undefined" != typeof h && (t = h)
                }
            return s = {
                sContents: t
            }, this.oApp.exec("MSG_STRING_CONVERTER_ENDED", [e, s]), s.sContents = s.sContents.replace(o, ""), s.sContents
        },
        ...
        addConverter: function(e, t) {
            var i = this.oConverters[e];
            i || (this.oConverters[e] = []), this.oConverters[e][this.oConverters[e].length] = t
        },
        addConverter_DOM: function(e, t) {
            var i = this.oConverters_DOM[e];
            i || (this.oConverters_DOM[e] = []), this.oConverters_DOM[e][this.oConverters_DOM[e].length] = t
        }
        ...
        $LOCAL_BEFORE_ALL: function(e, t) {
            var i = e.replace("$BEFORE_", ""),
                n = this.htMsgInfo[i];
            return 1 == n.nLoadingStatus ? !0 : 2 == n.nLoadingStatus ? (this[e] = function() {
                return this._removeHandler(e), this.oApp.delayedExec(i, t, 0), !1
            }, !0) : (n.bLoadingStatus = 1, new jindo.$Ajax(n.sURL, {
        ...
        _createBeforeHandlersAndSaveURLInfo: function(e, t, i, n) {
            ...
            var o = {
                sURL: t,
                elTarget: i,
                sSuccessCallback: n.sSuccessCallback,
        ...
        return null == this._instance && (this._instance = new function() {
            ...
            }, this.getCorrectKey = function(e, t) {
                var i = null;
                return e.forEach(function(e, n) {
                    return e == t ? void(i = n) : void 0
                }), i
    ...
    function() {
        var e = navigator.userAgent,
            ...
            i = t.navigator(),
            n = t.os(),
            o = e.match(/(SHW-|Chrome|Safari)/gi) || "";
        2 === o.length && "SHW-" === o[0] && "Safari" === o[1] ? i.bGalaxyBrowser = !0 : e.indexOf("LG-V500") > -1 && e.indexOf("Version/4.0") > -1 && (i.bGPadBrowser = !0), "undefined" == typeof n.ios && (n.ios = e.indexOf("iPad") > -1 || e.indexOf("iPhone") > -1, n.ios && (o = e.match(/(iPhone )?OS ([\d|_]+)/), null != o && void 0 != o[2] && (n.version = String(o[2]).split("_").join("."))))
        ...
        getScrollXY: function() {
            ...
            return "undefined" == typeof i.scrollX ? (e = i.document.documentElement.scrollLeft, t = i.document.documentElement.scrollTop) : (e = i.scrollX, t = i.scrollY), {
                x: e,
                y: t
            }
        }
        ...
        _removeEmptyFont: function(e) {
            for (var t, i, n = jindo.$$("font", e), o = 0; t = n[o]; o++) i = t.innerHTML || "", i = i.replace(this._rxSpaceOnly, ""), i || t.parentNode.removeChild(t)
        },
        convertFontToSpan: function(e) {
            if (e) {
                for (var t, i, n, o = e.ownerDocument || document, s = jindo.$$("font", e), r = 0; t = s[r]; r++) i = t.parentNode, ("SPAN" !== i.tagName || i.childNodes.length > 1) && (i = o.createElement("SPAN"), t.parentNode.insertBefore(i, t)), n = t.getAttribute("face"), n && (i.style.fontFamily = n), n = this._htFontSize[t.getAttribute("size")], n && (i.style.fontSize = n), n = t.getAttribute("color"), n && (i.style.color = n), this._switchFontInnerToSpan(t, i), t.parentNode && t.parentNode.removeChild(t);
                r > 0 && this._bUnderIE8 && (e.innerHTML = e.innerHTML.replace(this._rxFontStrip, ""))
            }
        },
        ...
        getCustomCSS: function(e, t, i) {
            var n = [];
            if ("undefined" == typeof e || "undefined" == typeof t || !e || !t) return n;
            var o = e.match(t);
        ...
        ellipsis: function(e, t, i, n) {
            ...
            o.html("A");
            var d = s.height();
            if (d * (n + .5) > l) return o.html(r);
            for (l = d; d * (n + .5) > l;) h += Math.max(Math.ceil((a - h) / 2), 1), o.html(r.substring(0, h) + i), l = s.height();
            for (; l > d * (n + .5);) h--, o.html(r.substring(0, h) + i), l = s.height()
        },
        ellipsisByPixel: function(e, t, i, n) {
            ...
            if (!(i > s)) {
                ...
                if ("undefined" == typeof n) {
                    var h = o.html("A").width();
                    for (s = h; i > s;) l += Math.max(Math.ceil((a - l) / 2), 1), o.html(r.substring(0, l) + t), s = o.width();
                    n = function() {
                        return !0
                    }
                }
                for (l = o.html().length - t.length; s > i && n();) l--, o.html(r.substring(0, l) + t), s = o.width()
            }
        },
        ellipsisElementsToDesinatedWidth: function(e, t, i, n) {
            jindo.$A(e).forEach(function(e, o) {
                e || jindo.$A.Continue(), nhn.husky.SE2M_Utils.ellipsisByPixel(e, t, i[o], n)
            })
        },
        ...
        cutStringToByte: function(e, t, i) {
            ...
            e = e.replace(/  +/g, " "), i || "" == i || (i = "...");
            for (var n = t, o = 0, s = e.length, r = 0; s > r; r++) {
                if (o += this.getCharByte(e.charAt(r)), o == n) return r == s - 1 ? e : e.substring(0, r) + i;
                if (o > n) return e.substring(0, r) + i
            }
            return e
        },
        ...
        getFilteredHashTable: function(e, t) {
            ...
            return jindo.$H(e).filter(function(e, t) {
                return i.has(t) && e ? !0 : !1
            }).$value()
        },
        isBlankNode: function(e) {
            var t = this.isBlankTextNode,
                i = function(e) {
                    return e ? t(e) ? !0 : "BR" == e.tagName ? !0 : "&nbsp;" == e.innerHTML || "" == e.innerHTML ? !0 : !1 : !0
                },
                n = function(e) {
                    ...
                    if ("P" == e.tagName) {
                        for (var n = e.childNodes.length - 1; n >= 0; n--) {
                            ...
                            t(o) && o.parentNode.removeChild(o)
                        }
                        if (1 == e.childNodes.length) {
                            if ("IMG" == e.firstChild.tagName || "IFRAME" == e.firstChild.tagName) return !1;
                            if (i(e.firstChild)) return !0
                        }
                    }
                    return !1
                };
            if (n(e)) return !0;
            for (var o = 0, s = e.childNodes.length; s > o; o++) {
        ...
        isBlankTextNode: function(e) {
            var t;
            return 3 == e.nodeType && (t = e.nodeValue, t = t.replace(unescape("%uFEFF"), ""), "" == t) ? !0 : !1
        },
        isFirstChildOfNode: function(e, t, i) {
            return i && i.tagName == t && i.firstChild.tagName == e ? !0 : !1
        },
        ...
        findAncestorByTagNameWithCount: function(e, t) {
            for (var i = 0, n = {}; t && t.tagName != e;) t = t.parentNode, i += 1;
            return n = {
                elNode: t,
                nRecursiveCount: i
            }
        ...
        findClosestAncestorAmongTagNamesWithCount: function(e, t) {
            for (var i = 0, n = {}, o = new RegExp("^(" + e.join("|") + ")$", "i"); t && !o.test(t.tagName);) t = t.parentNode, i += 1;
            return n = {
                elNode: t,
                nRecursiveCount: i
            }
        ...
        clone: function(e, t) {
            if ("undefined" != typeof e && e && (e.constructor == Array || e.constructor == Object)) {
                var i = e.constructor == Array ? [] : {};
                for (var n in e) "undefined" != typeof t && t[n] ? i[n] = arguments.callee(t[n]) : i[n] = arguments.callee(e[n]);
                return i
            }
            return e
        },
        getHtmlTagAttr: function(e, t) {
            var i = new RegExp("\\s" + t + "=('([^']*)'|\"([^\"]*)\"|([^\"' >]*))", "i"),
                n = i.exec(e);
            if (!n) return "";
            var o = n[1] || n[2] || n[3];
            return o && (o = o.replace(/[\"]/g, "")), o
        },
            ...
            var t = {},
                ...
                a = function(e) {
                    return "undefined" == typeof e ? "" : e.replace(/&[a-z]+;/g, function(e) {
                        return "string" == typeof s[e] ? s[e] : e
                    })
                },
                l = function(e, t) {
                    e.replace(/([\w\:\-]+)\s*=\s*(?:"((?:\\"|[^"])*)"|'((?:\\'|[^'])*)')/g, function(e, i, n, o) {
                        t[i] = a((n ? n.replace(/\\"/g, '"') : void 0) || (o ? o.replace(/\\'/g, "'") : void 0))
                    })
                },
                h = function(e) {
                    for (var t in e)
                ...
                d = function(e, t, i, s, d, c) {
                    var _, p = "",
                        E = r.stack.length - 1;
                    if ("string" == typeof t && t)
                        if ("/" != t.substr(0, 1)) {
                            var u = "string" == typeof i && i,
                                g = "string" == typeof s && s,
                                f = !u && g ? "" : {};
                            if (_ = r.stack[E], "undefined" == typeof _[t]) _[t] = f, _ = r.stack[E + 1] = _[t];
                            else if (_[t] instanceof Array) {
                                var A = _[t].length;
                                _[t][A] = f, _ = r.stack[E + 1] = _[t][A]
                            } else _[t] = [_[t], f], _ = r.stack[E + 1] = _[t][1];
                            u && l(i, _), r.tags[E + 1] = t, g && (r.tags.length--, r.stack.length--)
                        } else r.tags.length--, r.stack.length--;
                    else "string" == typeof d && d ? p = d : "string" == typeof c && c.replace(o, "") && (p = a(c));
                    if (p.length > 0) {
                        var S = r.stack[E - 1],
                            T = r.tags[E];
                        if (n.test(p) || ("true" == p || "false" == p) && (p = new Boolean(p)), "undefined" == typeof S) return;
                        if (S[T] instanceof Array) {
                            var C = S[T];
                            "object" != typeof C[C.length - 1] || h(C[C.length - 1]) ? C[C.length - 1] = p : (C[C.length - 1].$cdata = p, C[C.length - 1].toString = function() {
                                return p
                            })
                        } else "object" != typeof S[T] || h(S[T]) ? S[T] = p : (S[T].$cdata = p, S[T].toString = function() {
                            return p
                        })
                    }
                };
            return e = e.replace(/<(\?|\!-)[^>]*>/g, ""), e.replace(i, d), jindo.$Json(t)
        },
        ...
        _resize: function() {
            var e, t = this.welTextArea.$value().value,
                i = !1;
            t !== this.sContents && (this.sContents = t.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/ /g, "&nbsp;").replace(/\n/g, "<br>"), this.sContents += "<br>", this.welCloneDiv.html(this.sContents), e = this.welCloneDiv.height(), e < this.nMinHeight && (e = this.nMinHeight), this.welTextArea.css("height", e + "px"), this.elContainer.style.height = e + "px", this.nLastHeight < e && (i = !0), this.wfnCallback(i))
        }
    }), "undefined" != typeof StringBuffer && (StringBuffer = {}), StringBuffer = function(e) {
        this._aString = [], "undefined" != typeof e && this.append(e)
    }, StringBuffer.prototype.append = function(e) {
        return this._aString.push(e), this
    }, StringBuffer.prototype.toString = function() {
        return this._aString.join("")
    }, StringBuffer.prototype.setLength = function(e) {
        "undefined" == typeof e || 0 >= e ? this._aString.length = 0 : this._aString.length = e
    },
    function() {
        var e = null,
            t = /,/gi;
        IsInstalledFont = function(i) {
            var n = "Comic Sans MS" == i ? "Courier New" : "Comic Sans MS";
            e || (e = document.createElement("div"));
            var o = "position:absolute !important; font-size:200px !important; left:-9999px !important; top:-9999px !important;";
            e.innerHTML = "mmmmiiiii" + unescape("%uD55C%uAE00"), e.style.cssText = o + 'font-family:"' + n + '" !important';
            var s = document.body || document.documentElement;
            s.firstChild ? s.insertBefore(e, s.firstChild) : document.body.appendChild(e);
            var r = e.offsetWidth + "-" + e.offsetHeight;
            e.style.cssText = o + 'font-family:"' + i.replace(t, '","') + '", "' + n + '" !important';
            var a = r != e.offsetWidth + "-" + e.offsetHeight;
        ...
        $init: function() {
            if (this.htOptions = nhn.husky.SE2M_Configuration.SE2B_CSSLoader, jindo.$Agent().navigator().ie) {
                for (var e = 0, t = this.aInstantLoadTrigger.length; t > e; e++) this["$BEFORE_" + this.aInstantLoadTrigger[e]] = jindo.$Fn(function() {
                    this.loadSE2CSS()
                }, this).bind();
                for (var e = 0, t = this.aDelayedLoadTrigger.length; t > e; e++) {
...
nhn.husky.SE_OuterIFrameControl = $Class({
    ...
    oResizeGrip: null,
    $init: function(e) {
        this.aHeightChangeKeyMap = [-100, 100, 500, -500, -1, -10, 1, 10], this._assignHTMLObjects(e), this.$FnKeyDown = $Fn(this._keydown, this), this.oResizeGrip && this.$FnKeyDown.attach(this.oResizeGrip, "keydown"), jindo.$Agent().navigator().ie && (this.$FnMouseDown = $Fn(this._mousedown, this), this.$FnMouseMove = $Fn(this._mousemove, this), this.$FnMouseMove_Parent = $Fn(this._mousemove_parent, this), this.$FnMouseUp = $Fn(this._mouseup, this), this.oResizeGrip && this.$FnMouseDown.attach(this.oResizeGrip, "mousedown"))
    },
    _assignHTMLObjects: function(e) {
        e = jindo.$(e) || document, this.oResizeGrip = cssquery.getSingle(".husky_seditor_editingArea_verticalResizer", e), this.elIFrame = window.frameElement, this.welIFrame = $Element(this.elIFrame)
    },
    $ON_MSG_APP_READY: function() {
    ...
    $AFTER_RESIZE_EDITING_AREA_BY: function(e, t) {
        this.oApp.exec("SE_FIT_IFRAME", [])
    },
    _keydown: function(e) {
        var t = e.key();
        t.keyCode >= 33 && t.keyCode <= 40 && (this.oApp.exec("MSG_EDITING_AREA_RESIZE_STARTED", []), this.oApp.exec("RESIZE_EDITING_AREA_BY", [0, this.aHeightChangeKeyMap[t.keyCode - 33]]), this.oApp.exec("MSG_EDITING_AREA_RESIZE_ENDED", []), e.stop())
    },
    _mousedown: function(e) {
    ...
    _assignHTMLObjects: function(e, t) {
        e = jindo.$(e) || document, this.toolbarArea = cssquery.getSingle(".se2_tool", e), "undefined" == typeof t || t === !0 ? this.toolbarArea.style.display = "block" : this.toolbarArea.style.display = "none"
    },
    $ON_MSG_APP_READY: function() {
    ...
    $LOCAL_BEFORE_FIRST: function(e) {
        ...
        for (var t = 0; t < this.aCloseButtons.length; t++) {
            var i = jindo.$Fn(this.oApp.exec, this.oApp).bind("HIDE_FIND_REPLACE_LAYER", [this.elDropdownLayer]);
            jindo.$Fn(i, this).attach(this.aCloseButtons[t], "click")
        }
        ...
        var n = this.oApp.getWYSIWYGWindow().frameElement;
        this.htOffsetPos = jindo.$Element(n).offset(), this.nEditorWidth = n.offsetWidth, this.elDropdownLayer.style.display = "block", this.htInitialPos = this.welDropdownLayer.offset();
        this.oApp.oUtils.getScrollXY();
        this.welDropdownLayer.offset(this.htOffsetPos.top, this.htOffsetPos.left), this.htTopLeftCorner = {
    ...
    $ON_REPLACE_ALL: function() {
        ...
        this.oApp.exec("RECORD_UNDO_AFTER_ACTION", ["REPLACE ALL", {
            sSaveTarget: "BODY"
        }]), 0 === n ? (alert(this.oApp.$MSG("SE_FindReplace.replaceKeywordNotFound")), i.select(), this.oApp.exec("FOCUS")) : 0 > n ? (alert(this.oApp.$MSG("SE_FindReplace.keywordMissing")), i.select()) : (alert(this.oApp.$MSG("SE_FindReplace.replaceAllResultP1") + n + this.oApp.$MSG("SE_FindReplace.replaceAllResultP2")), i = this.oApp.getEmptySelection(), i.select(), this.oApp.exec("FOCUS"))
    }
    ...
    _isExceedMaxDepth: function(e) {
        var t = function(e) {
            var i = e.firstChild,
                n = 0,
                o = 0;
            if (!i) return e.tagName && "BLOCKQUOTE" === e.tagName ? 1 : 0;
            for (; i;) {
                if (1 === i.nodeType && (n = t(i), "BLOCKQUOTE" === i.tagName && (n += 1), n > o && (o = n), o >= this.nMaxLevel)) return o;
                i = i.nextSibling
            }
            return o
        };
        return t(e) >= this.nMaxLevel
    },
    ...
    _wrapBlock: function(e, t) {
        ...
        for (alert(this.oApp.$MSG("SE2M_Quote.exceedMaxCount").replace("#MaxCount#", this.nMaxLevel + 1)), this.oApp.exec("HIDE_ACTIVE_LAYER", []), E = p.nextSibling, u = p.parentNode, g = p.childNodes, f = [], jindo.$Element(p).leave(), A = 0, S = g.length; S > A; A++) f[A] = g[A];
        for (A = 0, S = f.length; S > A; A++) E ? jindo.$Element(E).before(f[A]) : jindo.$Element(u).append(f[A])
    },
    ...
    $LOCAL_BEFORE_FIRST: function(e) {
        ...
        var t = jindo.$Fn(this.oApp.exec, this.oApp).bind("INSERT_SCHARACTERS", [this.oTextField.value]);
        jindo.$Fn(t, this).attach(this.oInsertButton, "click"), this.oApp.exec("SET_SCHARACTER_LIST", [this.charSet]);
        for (var i = 0; i < this.aLabel.length; i++) {
            var n = jindo.$Fn(this.oApp.exec, this.oApp).bind("CHANGE_SCHARACTER_SET", [i]);
            jindo.$Fn(n, this).attach(this.aLabel[i].firstChild, "mousedown")
        }
    ...
    $ON_EVENT_SCHARACTER_CLICKED: function(e) {
        ...
        if (t && "BUTTON" == t.tagName && "LI" == t.parentNode.tagName) {
            ...
            i.length > 1 || (this.oApp.exec("SELECT_SCHARACTER", [i]), e.stop())
        }
    },
    ...
    _drawSCharList: function(e) {
        if (!this.bSCharSetDrawn[e]) {
            ...
            var t = this.charSet[e].length,
                i = new Array(t);
            this.aSCharList[e].innerHTML = "";
            for (var n, o, s = 0; t > s; s++) i[s] = jindo.$("<LI>"), this.bIE ? (n = jindo.$("<BUTTON>"), n.setAttribute("type", "button")) : (n = jindo.$("<BUTTON>"), n.type = "button"), o = jindo.$("<SPAN>"), o.innerHTML = unescape(this.charSet[e][s]), n.appendChild(o), i[s].appendChild(n), i[s].onmouseover = function() {
                this.className = "hover"
            }, i[s].onmouseout = function() {
                this.className = ""
            }, this.aSCharList[e].appendChild(i[s])
        }
    }
    ...
    $LOCAL_BEFORE_FIRST: function() {
        ...
        var e;
        for (e = 0; e < this.aElBtn_borderStyle.length; e++) this.oApp.registerBrowserEvent(this.aElBtn_borderStyle[e], "click", "TABLE_SELECT_BORDER_STYLE");
    ...
    $ON_TABLE_SET_ROW_NUM: function(e, t) {
        e = e || parseInt(this.elText_row.value, 10) || 0, t = t || 0, e += t, e < this.nMinRows && (e = this.nMinRows), e > this.nMaxRows && (e = this.nMaxRows), this.elText_row.value = e, this._showNewTable()
    },
    $ON_TABLE_SET_COLUMN_NUM: function(e, t) {
        e = e || parseInt(this.elText_col.value, 10) || 0, t = t || 0, e += t, e < this.nMinColumns && (e = this.nMinColumns), e > this.nMaxColumns && (e = this.nMaxColumns), this.elText_col.value = e, this._showNewTable()
    },
    _getTableString: function() {
        var e;
        return e = 1 == this.nStyleMode ? this._doGetTableString(this.nColumns, this.nRows, this.nBorderSize, this.sBorderColor, this.sBGColor, this.nBorderStyleIdx) : this._doGetTableString(this.nColumns, this.nRows, this.nBorderSize, this.sBorderColor, this.sBGColor, 0)
    },
    ...
    $ON_TABLE_SET_BORDER_SIZE: function(e, t) {
        e = e || parseInt(this.elText_borderSize.value, 10) || 0, t = t || 0, e += t, e < this.nMinBorderWidth && (e = this.nMinBorderWidth), e > this.nMaxBorderWidth && (e = this.nMaxBorderWidth), this.elText_borderSize.value = e
    },
    ...
    _getPreviewTableString: function(e, t) {
        for (var i = '<table border="0" cellspacing="1" class="se2_pre_table husky_se2m_table_preview">', n = "<tr>", o = 0; e > o; o++) n += "<td><p>&nbsp;</p></td>\n";
        n += "</tr>\n", i += "<tbody>";
        for (var o = 0; t > o; o++) i += n;
        return i += "</tbody>\n", i += "</table>\n"
    },
    ...
    _doGetTableString: function(e, t, i, n, o, s) {
        ...
        for (var h = 1 == s ? 'attr_no_border_tbl="1"' : "", d = "<table " + a + " " + h + ">", c = "<tr>", _ = 0; e > _; _++) c += "<td " + l + "><p>&nbsp;</p></td>\n";
        c += "</tr>\n", d += "<tbody>\n";
        for (var _ = 0; t > _; _++) d += c;
        return d += "</tbody>\n", d += "</table>\n<br>"
    },
    ...
    $LOCAL_BEFORE_FIRST: function(e) {
        if (e.indexOf("REGISTER_CONVERTERS") > -1) return this.oApp.acceptLocalBeforeFirstAgain(this, !0), !0;
    ...
    $BEFORE_CHANGE_EDITING_MODE: function(e, t) {
    ...
    $ON_TABLE_QE_SET_BGC: function(e) {
        ...
        for (var t = 0, i = this.aSelectedCells.length; i > t; t++) this.aSelectedCells[t].setAttribute(this.TMP_BGC_ATTR, e), this.aSelectedCells[t].removeAttribute(this.TMP_BGIMG_ATTR);
    ...
    $ON_TABLE_QE_SET_IMG: function(e) {
        for (var t = jindo.$Element(e).className(), i = jindo.$Element(this.elBtnBGIMGPalette), n = i.className().split(" "), o = 0, s = n.length; s > o; o++) n[o].indexOf("cellimg") > 0 && i.removeClass(n[o]);
        jindo.$Element(this.elBtnBGIMGPalette).addClass(t);
        var r = t.substring(11, t.length),
            a = "pattern_";
        if ("0" === r)
            for (var o = 0, s = this.aSelectedCells.length; s > o; o++) jindo.$Element(this.aSelectedCells[o]).css("backgroundImage", ""), this.aSelectedCells[o].removeAttribute(this.TMP_BGC_ATTR), this.aSelectedCells[o].removeAttribute(this.TMP_BGIMG_ATTR);
        else {
            a = 19 == r || 20 == r || 21 == r || 22 == r || 25 == r || 26 == r ? a + r + ".jpg" : a + r + ".gif";
            for (var l = 0, s = this.aSelectedCells.length; s > l; l++) jindo.$Element(this.aSelectedCells[l]).css("backgroundImage", "url(http://static.se2.naver.com/static/img/" + a + ")"), this.aSelectedCells[l].removeAttribute(this.TMP_BGC_ATTR), this.aSelectedCells[l].setAttribute(this.TMP_BGIMG_ATTR, "url(http://static.se2.naver.com/static/img/" + a + ")")
        }
    ...
    $ON_SETUP_TABLE_QE_MODE: function(e) {
        ...
        for (var i = this.aSelectedCells[0].getAttribute(this.TMP_BGC_ATTR) || "rgb(255,255,255)", n = !0, o = 1, s = this.aSelectedCells.length; s > o; o++)
            if (this.aSelectedCells[o] && i != this.aSelectedCells[o].getAttribute(this.TMP_BGC_ATTR)) {
                n = !1;
                break
            } n ? this.elBtnBGPalette.style.backgroundColor = i : this.elBtnBGPalette.style.backgroundColor = "#FFFFFF";
        ...
        if (a) {
            var c = a.match(/\_[0-9]*/);
            r = c ? c[0] : "_0", h = r.substring(1, r.length);
            for (var o = 1, s = this.aSelectedCells.length; s > o; o++)
                if (a != this.aSelectedCells[o].getAttribute(this.TMP_BGIMG_ATTR)) {
                    l = !1;
                    break
                }
        }
        for (var _ = d.className().split(/\s/), p = 0, s = _.length; s > p; p++) _[p].indexOf("cellimg") > 0 && d.removeClass(_[p]);
        if (l && h > 0 ? d.addClass("se2_cellimg" + h) : d.addClass("se2_cellimg0"), 0 === this.nQEMode) {
        ...
        } else if (1 == this.nQEMode) {
            this.elPanelTableTemplateArea.style.display = "none", this.elPanelReviewBGArea.style.display = "block";
            var E = this.parseIntOr0(this.elSelectionStartTable.getAttribute(this.ATTR_REVIEW_TEMPLATE));
            this.elPanelBGImg.style.position = "relative"
        } else this.elPanelTableTemplateArea.style.display = "none", this.elPanelReviewBGArea.style.display = "none";
    ...
    $ON_TABLE_QE_DIM: function(e, t) {
        var i, n = "se2_qdim";
        i = 1 == e ? this.elPanelDim1 : this.elPanelDim2, t && (e = 0), i.className = n + e
    },
    ...
    $ON_TE_MERGE_CELLS: function() {
        if (0 !== this.aSelectedCells.length && 1 != this.aSelectedCells.length) {
            ...
            var n, o, s = (nhn.husky.SE2M_Utils.findAncestorByTagName("TABLE", t), this.aSelectedCells[0]);
            for (n = parseInt(s.style.height || s.getAttribute("height"), 10), o = parseInt(s.style.width || s.getAttribute("width"), 10), e = this.htSelectionSPos.x + 1; e < this.htSelectionEPos.x + 1; e++) curTD = this.htMap[e][this.htSelectionSPos.y], curTD != s && (s = curTD, o += parseInt(curTD.style.width || curTD.getAttribute("width"), 10));
            for (s = this.aSelectedCells[0], e = this.htSelectionSPos.y + 1; e < this.htSelectionEPos.y + 1; e++) curTD = this.htMap[this.htSelectionSPos.x][e], curTD != s && (s = curTD, n += parseInt(curTD.style.height || curTD.getAttribute("height"), 10));
            for (o && (t.style.width = o + "px"), n && (t.style.height = n + "px"), t.setAttribute("colSpan", this.htSelectionEPos.x - this.htSelectionSPos.x + 1), t.setAttribute("rowSpan", this.htSelectionEPos.y - this.htSelectionSPos.y + 1), e = 1; e < this.aSelectedCells.length; e++)
                if (i = this.aSelectedCells[e], i.parentNode) {
    ...
    $ON_TE_SPLIT_COLUMN: function() {
        ...
        if (0 !== this.aSelectedCells.length) {
            this._removeClassFromSelection();
            for (var r = this.aSelectedCells[0], a = 0, l = this.aSelectedCells.length; l > a; a++)
                if (o = this.aSelectedCells[a], e = parseInt(o.getAttribute("colSpan"), 10) || 1, !(e > 1))
            ...
            for (var a = 0, l = this.aSelectedCells.length; l > a; a++) {
                o = this.aSelectedCells[a], e = parseInt(o.getAttribute("colSpan"), 10) || 1, t = (e / 2).toFixed(0), o.setAttribute("colSpan", t), s = this._shallowCloneTD(o), s.setAttribute("colSpan", e - t), r = s, e = parseInt(o.getAttribute("rowSpan"), 10) || 1, s.setAttribute("rowSpan", e), s.innerHTML = "&nbsp;", i = o.width || o.style.width, i && (i = this.parseIntOr0(i), o.removeAttribute("width"), n = (i / 2).toFixed(), o.style.width = n + "px", s.style.width = i - n + "px"), o.parentNode.insertBefore(s, o.nextSibling);
                var c = jindo.$Agent().navigator();
                (c.edge && 12 === Math.floor(c.version) || c.ie && (c.nativeVersion >= 9 || c.nativeVersion <= 11) && (c.version >= 9 || c.version <= 11)) && (s.style.cssText = o.style.cssText)
            }
            this._reassignCellSizes(this.elSelectionStartTable), this.htMap = this._getCellMapping(this.elSelectionStartTable);
            var h = this._getBasisCellPosition(r);
            this.htSelectionEPos.x = h.x, this._selectCells(this.htSelectionSPos, this.htSelectionEPos), this.sQEAction = "SPLIT_TABLE_COLUMN", this.oApp.exec("SHOW_COMMON_QE")
        }
    },
    $ON_TE_SPLIT_ROW: function() {
        ...
        if (0 !== this.aSelectedCells.length) {
            ...
            this._removeClassFromSelection();
            for (var l, h = 0, d = 0, c = this.aSelectedCells.length; c > d; d++)
                if (n = this.aSelectedCells[d], e = parseInt(n.getAttribute("rowSpan"), 10) || 1, !(e > 1)) {
                    s = this._getBasisCellPosition(n), l = a[s.y], r = this.oApp.getWYSIWYGDocument().createElement("TR"), l.parentNode.insertBefore(r, l.nextSibling), h++;
                    for (var _ = 0; _ < this.htMap.length;) n = this.htMap[_][s.y], e = parseInt(n.getAttribute("rowSpan"), 10) || 1, n.setAttribute("rowSpan", e + 1), _ += parseInt(n.getAttribute("colSpan"), 10) || 1
                } a = jindo.$$(">TBODY>TR", this.elSelectionStartTable, {
                oneTimeOffCache: !0
            });
            for (var p, E, d = 0, c = this.aSelectedCells.length; c > d; d++) {
                n = this.aSelectedCells[d], e = parseInt(n.getAttribute("rowSpan"), 10) || 1, t = (e / 2).toFixed(0), n.setAttribute("rowSpan", t), o = this._shallowCloneTD(n), o.setAttribute("rowSpan", e - t), e = parseInt(n.getAttribute("colSpan"), 10) || 1, o.setAttribute("colSpan", e), o.innerHTML = "&nbsp;", i = n.height || n.style.height, i && (i = this.parseIntOr0(i), n.removeAttribute("height"), nNewHeight = (i / 2).toFixed(), n.style.height = nNewHeight + "px", o.style.height = i - nNewHeight + "px");
                var u, g = jindo.$A(a).indexOf(n.parentNode),
                    f = parseInt(g, 10) + parseInt(t, 10),
                    A = a[f],
                    S = A.childNodes,
                    T = null;
                p = this._getBasisCellPosition(n);
                for (var C = 0, m = S.length; m > C; C++)
                    if (u = S[C], u.tagName && this._rxCellNames.test(u.tagName) && (E = this._getBasisCellPosition(u), p.x < E.x)) {
                        T = u;
                        break
                    } A.insertBefore(o, T);
                var R = jindo.$Agent().navigator();
                (R.edge && 12 === Math.floor(R.version) || R.ie && (R.nativeVersion >= 9 || R.nativeVersion <= 11) && (R.version >= 9 || R.version <= 11)) && (o.style.cssText = o.style.cssText)
            }
            this._reassignCellSizes(this.elSelectionStartTable), this.htMap = this._getCellMapping(this.elSelectionStartTable), this.htSelectionEPos.y += h, this._selectCells(this.htSelectionSPos, this.htSelectionEPos), this.sQEAction = "SPLIT_TABLE_ROW", this.oApp.exec("SHOW_COMMON_QE")
        }
    },
    ...
    $ON_EVENT_EDITING_AREA_MOUSEMOVE: function(e) {
        if ("WYSIWYG" == this.oApp.getEditingMode()) {
            var t = e.element,
                ...
                n = "onpointerup",
                o = "onresizeend";
            switch (i.ie && t && t.tagName && "TABLE" === t.tagName.toUpperCase() && (n in t ? t[n] = this._wfnOnResizeEndTable : o in t && (i.version > 8 ? t[o] = this._wfnOnResizeEndTable : t[o] = this._getTableResizeEndHandler(t))), this.nStatus) {
                case this.STATUS.S_0:
                ...
                case this.STATUS.CELL_SELECTING:
                    var s = nhn.husky.SE2M_Utils.findClosestAncestorAmongTagNames(this._aCellName, e.element);
                    if (!s || s === this.elLastSelectedTD) return;
                    var r = nhn.husky.SE2M_Utils.findAncestorByTagName("TABLE", s);
                    if (r !== this.elSelectionStartTable) return;
    ...
    $ON_EVENT_OUTER_DOC_MOUSEMOVE: function(e) {
        switch (this.nStatus) {
            case this.STATUS.CELL_SELECTING:
                ...
                } else if (i > this.htEditingAreaPos.bottom) {
                    var o = this.htSelectionEPos.y;
                    if (o < this.htMap[0].length - 1) {
                        this.htSelectionEPos.y++, this._selectCells(this.htSelectionSPos, this.htSelectionEPos);
                        var s = this.oApp.getSelection();
                        s.selectNodeContents(this.htMap[this.htSelectionEPos.x][this.htSelectionEPos.y]), s.select(), s.oBrowserSelection.selectNone()
                    }
                }
                ...
                } else if (n > this.htEditingAreaPos.right) {
                    var r = this.htSelectionEPos.x;
                    if (r < this.htMap.length - 1) {
    ...
    _eventEditingAreaMouseup: function(e) {
    ...
    _reassignCellSizes: function(e) {
        ...
        for (var i = new Array(t[0].length + t[1].length), n = 0, o = (this.parseIntOr0(e.border), this.parseIntOr0(e.cellPadding), 0); 2 > o; o++)
            for (var s = 0; s < t[o].length; s++) {
                var r, a, l, h, d, c, _, p, E, u, g = t[o][s],
                    f = jindo.$Element(g);
                jindo.$Agent().navigator();
                g.getComputedStyle ? (r = parseFloat(getComputedStyle(g).paddingLeft, 10), a = parseFloat(getComputedStyle(g).paddingRight, 10), l = parseFloat(getComputedStyle(g).paddingTop, 10), h = parseFloat(getComputedStyle(g).paddingBottom, 10), d = parseFloat(getComputedStyle(g).borderLeftWidth, 10), c = parseFloat(getComputedStyle(g).borderRightWidth, 10), _ = parseFloat(getComputedStyle(g).borderTopWidth, 10), p = parseFloat(getComputedStyle(g).borderBottomWidth, 10)) : (r = this.parseIntOr0(g.style.paddingLeft), a = this.parseIntOr0(g.style.paddingRight), l = this.parseIntOr0(g.style.paddingTop), h = this.parseIntOr0(g.style.paddingBottom), d = this.parseBorder(f.css("borderLeftWidth"), f.css("borderLeftStyle")), c = this.parseBorder(f.css("borderRightWidth"), f.css("borderRightStyle")), _ = this.parseBorder(f.css("borderTopWidth"), f.css("borderTopStyle")), p = this.parseBorder(f.css("borderBottomWidth"), f.css("borderBottomStyle")));
                var A = jindo.$Element(g).attr("width"),
                    S = jindo.$Element(g).attr("height");
                A || S ? (E = g.offsetWidth - (r + a + d + c) + "px", u = g.offsetHeight - (l + h + _ + p) + "px") : (E = g.style.width, u = g.style.height), i[n++] = [g, E, u]
            }
        var T = e._nWidth,
            C = e._nHeight,
            m = e._nResizedWidth,
            ...
            N = 1,
            L = 1;
        nhn.husky.SE2M_Utils.isNumber(T) && nhn.husky.SE2M_Utils.isNumber(C) && nhn.husky.SE2M_Utils.isNumber(m) && nhn.husky.SE2M_Utils.isNumber(R) && (N = m / T, L = R / C), e._nResizedWidth && nhn.husky.SE2M_Utils.deleteProperty(e, "_nResizedWidth"), e._nResizedHeight && nhn.husky.SE2M_Utils.deleteProperty(e, "_nResizedHeight");
        for (var s = 0; n > s; s++) {
            var O = i[s];
            O[0].removeAttribute("width"), O[0].removeAttribute("height"), O[0].style.width = parseFloat(O[1], 10) * N + "px", O[0].style.height = parseFloat(O[2], 10) * L + "px"
        }
    ...
    _fnOnMouseDownResizeCover: function(e) {
        ...
        0 > o || 0 > s || (this.htAllAffectedCells = this._getAllAffectedCells(o, s, this.htResizing.nResizeMode, this.htResizing.elTable))
    },
    _fnOnMouseMoveResizeCover: function(e) {
        (jindo.$Agent().navigator().chrome || jindo.$Agent().navigator().safari) && void 0 != this.htResizing.nPreviousResizeMode && 0 != this.htResizing.nPreviousResizeMode && this.htResizing.nResizeMode != this.htResizing.nPreviousResizeMode && (this.htResizing.nResizeMode = this.htResizing.nPreviousResizeMode, this._showResizer());
        e.pos().clientY - this.nStartHeight, e.pos().clientX - this.nStartWidth, e.pos();
    ...
    _fnOnMouseUpResizeCover: function(e) {
        ...
        var t = 0,
            i = 0;
        2 == this.htResizing.nResizeMode && (t = e.pos().clientY - this.nStartHeight), 1 == this.htResizing.nResizeMode && (i = e.pos().clientX - this.nStartWidth, -1 != this.htAllAffectedCells.nMinBefore && i < -1 * this.htAllAffectedCells.nMinBefore && (i = -1 * this.htAllAffectedCells.nMinBefore + this.MIN_CELL_WIDTH), -1 != this.htAllAffectedCells.nMinAfter && i > this.htAllAffectedCells.nMinAfter && (i = this.htAllAffectedCells.nMinAfter - this.MIN_CELL_WIDTH));
        for (var n, o, s = this.htAllAffectedCells.aCellsBefore, r = 0; r < s.length; r++) {
            var a = s[r];
            n = 0, o = 0, n = a.style.width, n = isNaN(parseFloat(n, 10)) ? 0 : parseFloat(n, 10), n += i, o = a.style.height, o = isNaN(parseFloat(o, 10)) ? 0 : parseFloat(o, 10), o += t, a.style.width = Math.max(n, this.MIN_CELL_WIDTH) + "px", a.style.height = Math.max(o, this.MIN_CELL_HEIGHT) + "px"
        }
        for (var l = this.htAllAffectedCells.aCellsAfter, r = 0; r < l.length; r++) {
            var a = l[r];
            n = 0, o = 0, n = a.style.width, n = isNaN(parseFloat(n, 10)) ? 0 : parseFloat(n, 10), n -= i, o = a.style.height, o = isNaN(parseFloat(o, 10)) ? 0 : parseFloat(o, 10), o -= t, a.style.width = Math.max(n, this.MIN_CELL_WIDTH) + "px", a.style.height = Math.max(o, this.MIN_CELL_HEIGHT) + "px"
        }
        ...
        if (o)
            for (i = r; i--;)
                if (t = s[i], o.hasClass(t)) {
                    a = !0;
                    break
                } a || this._changeTableEditorStatus(this.STATUS.S_0)
    },
    _changeTableEditorStatus: function(e) {
        if (this.nStatus != e) {
            switch (this.nStatus = e, e) {
                case this.STATUS.S_0:
    ...
    _isOnBorder: function(e) {
        ...
        if (this.htResizing.elTable = nhn.husky.SE2M_Utils.findAncestorByTagName("TABLE", this.htResizing.elCell), this.htResizing.elTable && (jindo.$Element(this.htResizing.elTable).hasClass(this._sSETblClass) || jindo.$Element(this.htResizing.elTable).hasClass(this._sSEReviewTblClass))) {
            this.htResizing.nVA = 0, this.htResizing.nHA = 0, this.htResizing.nBorderLeftPos = 0, this.htResizing.nBorderTopPos = -1, this.htResizing.htEPos = e.pos(!0), this.htResizing.nBorderSize = this.parseIntOr0(this.htResizing.elTable.border);
            var t, i;
            jindo.$Agent().navigator().ie || jindo.$Agent().navigator().safari ? (t = this.htResizing.nBorderSize + this.nDraggableCellEdge, i = this.nDraggableCellEdge) : (t = this.nDraggableCellEdge, i = this.htResizing.nBorderSize + this.nDraggableCellEdge);
            var n = this.htResizing.elCell.clientWidth,
                o = this.htResizing.elCell.clientHeight;
            if (nRightBorderCriteria = n - this.htResizing.htEPos.offsetX, nBottomBorderCriteria = o - this.htResizing.htEPos.offsetY, this.htResizing.htEPos.offsetY <= t) {
                var s = !1,
                    r = this.htResizing.elCell.parentNode,
                    a = r.parentNode,
                    l = jindo.$$("tr", a, {
                        oneTimeOffCache: !0
                    });
                l[0] == r && (s = !0), s && (this.htResizing.nVA = -1, this.htResizing.nResizeMode = 4)
            }
            return nBottomBorderCriteria <= i && (this.htResizing.nBorderTopPos = this.htResizing.elCell.offsetHeight + t - 1, this.htResizing.nResizeMode = 2), this.htResizing.htEPos.offsetX <= t && this.htResizing.elTable.scrollLeft != this.htResizing.elCell.offsetLeft && (this.htResizing.nHA = -1, this.htResizing.nResizeMode = 3), nRightBorderCriteria <= t && (this.htResizing.nBorderLeftPos = this.htResizing.elCell.offsetWidth + t - 1, this.htResizing.nResizeMode = 1), (jindo.$Agent().navigator().chrome || jindo.$Agent().navigator().safari) && (this.htResizing.elPreviousCell ? this.htResizing.elCell != this.htResizing.elPreviousCell && (this.htResizing.elPreviousCell = this.htResizing.elCell) : this.htResizing.elPreviousCell = this.htResizing.elCell), 0 === this.htResizing.nResizeMode ? !1 : !0
        }
    },
    ...
    _getAllAffectedCells: function(e, t, i, n) {
        ...
        if (1 == i) {
            for (var _ = 0; a > _; _++)
                if (!(l.length > 0 && l[l.length - 1] == s[e][_])) {
                    l[l.length] = s[e][_];
                    var p = parseInt(s[e][_].style.width);
                    (-1 == d || d > p) && (d = p)
                } if (s.length > e + 1)
                for (var _ = 0; a > _; _++)
                    if (!(h.length > 0 && h[h.length - 1] == s[e + 1][_])) {
                        h[h.length] = s[e + 1][_];
                        var p = parseInt(s[e + 1][_].style.width);
                        (-1 == c || c > p) && (c = p)
                    } o = {
                aCellsBefore: l,
                aCellsAfter: h,
            ...
            for (var E = 0; r > E; E++) l.length > 0 && l[l.length - 1] == s[E][t] || (l[l.length] = s[E][t], (-1 == d || d > s[E][t].style.height) && (d = s[E][t].style.height));
            o = {
                aCellsBefore: l,
                aCellsAfter: h,
                nMinBefore: d,
    ...
    _createCellResizeGrip: function() {
        ...
        var t = jindo.$$.getSingle(".husky_seditor_editing_area_container");
        t.appendChild(this.elResizeGrid)
    },
    ...
    _deleteSelectedCells: function() {
        for (var e, t = 0, i = this.aSelectedCells.length; i > t; t++) {
        ...
        var o = jindo.$$(">TBODY>TR", this.elSelectionStartTable, {
            ...
            s = this.htSelectionEPos.x - this.htSelectionSPos.x + 1,
            r = this.htMap.length;
        if (s == r) {
            for (var t = 0, i = o.length; i > t; t++)
                if (e = o[t], !this.htMap[0][t] || !this.htMap[0][t].parentNode || "TR" !== this.htMap[0][t].parentNode.tagName) {
                    var n = jindo.$Agent().navigator();
                    !n.ie || 9 != n.nativeVersion && 10 != n.nativeVersion || 9 != n.version && 10 != n.version || this._removeEmptyTextNode_IE(e), e.parentNode.removeChild(e)
    ...
    _insertColumnAfter: function() {
        ...
        for (var e, t, i, n, o = jindo.$$(">TBODY>TR", this.elSelectionStartTable, {
                oneTimeOffCache: !0
            }), s = "_tmp_inserted", r = jindo.$Agent().navigator(), a = 0, l = this.htMap[0].length; l > a; a++) {
            i = o[a];
            for (var h = this.htSelectionEPos.x; h >= this.htSelectionSPos.x; h--) {
                e = this.htMap[h][a], t = this._shallowCloneTD(e);
                var d = parseInt(e.getAttribute("rowSpan"));
                d > 1 && (t.setAttribute("rowSpan", 1), t.style.height = ""), d = parseInt(e.getAttribute("colSpan")), d > 1 && (t.setAttribute("colSpan", 1), t.style.width = ""), n = null;
                for (var c = this.htSelectionEPos.x; c >= this.htSelectionSPos.x; c--)
                    if (this.htMap[c][a].parentNode == i) {
                        n = this.htMap[c][a].nextSibling;
                        break
                    } i.insertBefore(t, n), (r.edge && 12 === Math.floor(r.version) || r.ie && (r.nativeVersion >= 9 || r.nativeVersion <= 11) && (r.version >= 9 || r.version <= 11)) && (t.style.cssText = t.style.cssText)
            }
        }
        for (var _ = 0, p = this.aSelectedCells.length; p > _; _++) this.aSelectedCells[_].removeAttribute(s);
        var E = this.htSelectionEPos.x - this.htSelectionSPos.x + 1;
        this.htSelectionEPos.y - this.htSelectionSPos.y + 1;
        this.htSelectionSPos.x += E, this.htSelectionEPos.x += E, this.htMap = this._getCellMapping(this.elSelectionStartTable), this._selectCells(this.htSelectionSPos, this.htSelectionEPos), this._showTableTemplate(this.elSelectionStartTable), this._addClassToSelection(), this.sQEAction = "INSERT_TABLE_COLUMN", this.oApp.exec("SHOW_COMMON_QE")
    },
    _insertRowBelow: function() {
        ...
        for (var e, t = this.htMap[0][0].parentNode.parentNode, i = jindo.$$(">TR", t, {
                oneTimeOffCache: !0
            }), n = i[this.htSelectionEPos.y + 1] || null, o = jindo.$Agent().navigator(), s = this.htSelectionSPos.y; s <= this.htSelectionEPos.y; s++)
            if (e = this._getTRCloneWithAllTD(s), t.insertBefore(e, n), o.edge && 12 === Math.floor(o.version) || o.ie && (o.nativeVersion >= 9 || o.nativeVersion <= 11) && (o.version >= 9 || o.version <= 11)) {
                for (var r = this.htMap[0][s].parentNode, a = r.childNodes, l = [], h = 0, d = a.length; d > h; h++) this._rxCellNames.test(a[h].nodeName) && l.push(a[h].cloneNode());
                for (var c = e.childNodes, h = 0, d = c.length; d > h; h++) {
                    var _ = c[h],
                        p = l[h];
                    this._rxCellNames.test(_.nodeName) && p && this._rxCellNames.test(p.nodeName) && (_.style.cssText = p.style.cssText)
                }
            } var E = (this.htSelectionEPos.x - this.htSelectionSPos.x + 1, this.htSelectionEPos.y - this.htSelectionSPos.y + 1);
        this.htSelectionSPos.y += E, this.htSelectionEPos.y += E, this.htMap = this._getCellMapping(this.elSelectionStartTable), this._selectCells(this.htSelectionSPos, this.htSelectionEPos), this._showTableTemplate(this.elSelectionStartTable), this._addClassToSelection(), this.sQEAction = "INSERT_TABLE_ROW", this.oApp.exec("SHOW_COMMON_QE")
    },
    ...
    _getNextCell: function(e) {
        for (; e;)
            if (e = e.nextSibling, e && e.tagName && e.tagName.match(/^TD|TH$/)) return e;
        return null
    },
    _getCellMapping: function(e) {
        ...
        for (var r = i, a = t.length, l = new Array(r), h = 0; r > h; h++) l[h] = new Array(a);
        for (var d = 0; a > d; d++) {
            var c = t[d].childNodes[0];
            if (c) {
                c.tagName && c.tagName.match(/^TD|TH$/) || (c = this._getNextCell(c));
                for (var h = -1; c;)
                    if (h++, l[h] || (l[h] = []), !l[h][d]) {
                        for (var _ = parseInt(c.getAttribute("colSpan"), 10) || 1, p = parseInt(c.getAttribute("rowSpan"), 10) || 1, E = 0; p > E; E++)
                            for (var u = 0; _ > u; u++) l[h + u] || (l[h + u] = []), l[h + u][d + E] = c;
                        c = this._getNextCell(c)
                    }
            }
        }
        for (var g = !1, f = null, d = 0, A = 0, S = l[0].length; S > d; d++, A++)
            if (f = null, !t[d].innerHTML.match(/TD|TH/i)) {
                for (var h = 0, T = l.length; T > h; h++)
                    if (c = l[h][d], c && c !== f) {
                        f = c;
                        var p = parseInt(c.getAttribute("rowSpan"), 10) || 1;
                        p > 1 && c.setAttribute("rowSpan", p - 1)
                    } var C = jindo.$Agent().navigator();
                !C.ie || 9 != C.nativeVersion && 10 != C.nativeVersion || 9 != C.version && 10 != C.version || this._removeEmptyTextNode_IE(t[d]), t[d].parentNode.removeChild(t[d]), this.htSelectionEPos.y >= A && (A--, this.htSelectionEPos.y--), g = !0
            } return g ? this._getCellMapping(e) : l
    },
    ...
    _addClassToSelection: function() {
        for (var e, t, i = 0; i < this.aSelectedCells.length; i++) t = this.aSelectedCells[i], t && (null == t.ondragstart && (t.ondragstart = function() {
            return !1
        }), e = jindo.$Element(t), e.addClass(this.CELL_SELECTION_CLASS), e.addClass("undraggable"), t.style.backgroundColor && (t.setAttribute(this.TMP_BGC_ATTR, t.style.backgroundColor), e.css("backgroundColor", "")), t.style.backgroundImage && (t.setAttribute(this.TMP_BGIMG_ATTR, t.style.backgroundImage), e.css("backgroundImage", "")))
    },
    _removeClassFromSelection: function() {
        for (var e, t, i = 0; i < this.aSelectedCells.length; i++) t = this.aSelectedCells[i], t && (e = jindo.$Element(t), e.removeClass(this.CELL_SELECTION_CLASS), e.removeClass("undraggable"), t.getAttribute(this.TMP_BGC_ATTR) && (t.style.backgroundColor = t.getAttribute(this.TMP_BGC_ATTR), t.removeAttribute(this.TMP_BGC_ATTR)),
            t.getAttribute(this.TMP_BGIMG_ATTR) && (e.css("backgroundImage", t.getAttribute(this.TMP_BGIMG_ATTR)), t.removeAttribute(this.TMP_BGIMG_ATTR)))
    },
    ...
    _getSelectedCells: function(e, t) {
        ...
        for (var r = [], a = n; s >= a; a++)
            for (var l = i; o >= l; l++) jindo.$A(r).has(this.htMap[l][a]) || (r[r.length] = this.htMap[l][a]);
        return r
    },
    ...
    _clearAllTableStyles: function(e) {
        ...
        for (var t = jindo.$$(">TBODY>TR>TD", e, {
                oneTimeOffCache: !0
            }), i = 0, n = t.length; n > i; i++) t[i].style.padding = "", t[i].style.border = "", t[i].style.backgroundColor = "", t[i].style.color = "";
        for (var o = jindo.$$(">TBODY>TR>TH", e, {
                oneTimeOffCache: !0
            }), i = 0, n = o.length; n > i; i++) o[i].style.padding = "", o[i].style.border = "", o[i].style.backgroundColor = "", o[i].style.color = ""
    },
    ...
    _doApplyTableTemplate: function(e, t, i) {
        ...
        var h = jindo.$$(">TBODY>TR", e, {
                oneTimeOffCache: !0
            }),
            d = 0;
        if (r)
            for (var d = 1, c = 0, _ = h[0].childNodes.length; _ > c; c++) n = h[0].childNodes[c], n.tagName && n.tagName.match(/^TD|TH$/) && this._copyStylesTo(n, r, i);
        var p, E;
        if (a)
            for (var u = r ? 1 : 0, g = u, f = h.length; f > g;) E = h[g].firstChild, p = 1, E && E.tagName.match(/^TD|TH$/) && (p = parseInt(E.getAttribute("rowSpan"), 10) || 1, this._copyStylesTo(E, a, i)), g += p;
        if (l)
            for (var A = l.length, g = d, f = h.length; f > g; g++)
                for (var c = 0, _ = h[g].childNodes.length; _ > c; c++) {
                    var n = h[g].childNodes[c];
                    n.tagName && n.tagName.match(/^TD|TH$/) && this._copyStylesTo(n, l[(g + d) % A], i)
                }
    },
    _copyAttributesTo: function(e, t, i) {
        var n;
        for (var o in t) t.hasOwnProperty(o) && (i ? e[o] && (n = document.createElement(e.tagName), n[o] = t[o], n[o] == e[o] && e.removeAttribute(o)) : (n = document.createElement(e.tagName), n.style[o] = "", e[o] && e.style[o] != n.style[o] || e.setAttribute(o, t[o])))
    },
    _copyStylesTo: function(e, t, i) {
        var n;
        for (var o in t) t.hasOwnProperty(o) && (i ? e.style[o] && (n = document.createElement(e.tagName), n.style[o] = t[o], n.style[o] == e.style[o] && (e.style[o] = "")) : (n = document.createElement(e.tagName), n.style[o] = "", (!e.style[o] || e.style[o] == n.style[o] || o.match(/^border/)) && (e.style[o] = t[o])))
    },
    ...
    _getTRCloneWithAllTD: function(e) {
        for (var t, i, n = this.htMap[0][e].parentNode.cloneNode(!1), o = 0, s = this.htMap.length; s > o; o++) t = this.htMap[o][e], this._rxCellNames.test(t.tagName) && (i = this._shallowCloneTD(t), i.setAttribute("rowSpan", 1), i.setAttribute("colSpan", 1), i.style.width = "", i.style.height = "", n.insertBefore(i, null));
        return n
    },
    ...
    $ON_EVENT_APPLY_BGCOLOR: function(e) {
        ...
        if ("BUTTON" == t.tagName) {
            var i, n;
            i = t.style.backgroundColor, n = t.style.color, this.oApp.exec("APPLY_BGCOLOR", [i, n])
        }
    },
    ...
    $ON_APPLY_BGCOLOR: function(e, t) {
        if (!this.rxColorPattern.test(e)) return void alert(this.oApp.$MSG("SE_Color.invalidColorCode"));
    ...
    $ON_APPLY_FONTCOLOR: function(e) {
        return this.rxColorPattern.test(e) ? (this._setLastUsedFontColor(e), this.oApp.exec("SET_WYSIWYG_STYLE", [{
            color: e
        }]), void this.oApp.exec("HIDE_ACTIVE_LAYER")) : void alert(this.oApp.$MSG("SE_FontColor.invalidColorCode"))
    }
    ...
    $ON_MSG_HYPERLINK_LAYER_SHOWN: function() {
        ...
        if (e || (e = this._getSelectedNode()), e && !this.oSelection.collapsed) {
    ...
    _validateTarget: function() {
        var e = jindo.$Agent().navigator(),
            t = !0;
        return e.ie && jindo.$A(this.oSelection.getNodes(!0)).forEach(function(e, i, n) {
    ...
    $ON_APPLY_HYPERLINK: function() {
        if (!this._validateTarget()) return void alert(this.oApp.$MSG("SE_Hyperlink.invalidTarget"));
        ...
        if (this.oApp.exec("IE_FOCUS", []), t.ie && (i = '<span style="text-decoration:none;">&nbsp;</span>'), this._validateURL(e)) {
            ...
            if (this.oSelection.collapsed) {
                var o = "<a href='" + e + "' target=" + sTarget + ">" + e + "</a>" + i;
                this.oSelection.pasteHTML(o), n = this.oSelection.placeStringBookmark()
            } else {
                ...
                var s = Math.ceil(1e4 * Math.random());
                if ("" == e) this.oApp.exec("EXECCOMMAND", ["unlink"]);
                else if (this._isExceptional()) {
                    this.oApp.exec("EXECCOMMAND", ["unlink", !1, "", {
                        bDontAddUndoHistory: !0
                    }]);
                    var r = "<a href='" + e + "' target=" + sTarget + ">";
                    jindo.$A(this.oSelection.getNodes(!0)).forEach(function(e, t, i) {
                        var n = this.oApp.getEmptySelection();
                        3 === e.nodeType ? (n.selectNode(e), n.pasteHTML(r + e.nodeValue + "</a>")) : 1 === e.nodeType && "IMG" === e.tagName && (n.selectNode(e), n.pasteHTML(r + jindo.$Element(e).outerHTML() + "</a>"))
                    }, this)
                } else this.oApp.exec("EXECCOMMAND", ["createLink", !1, this.sATagMarker + s + encodeURIComponent(e), {
                    bDontAddUndoHistory: !0
                }]);
                for (var a, l = this.oApp.getWYSIWYGDocument(), h = l.body.getElementsByTagName("A"), d = h.length, c = new RegExp(this.sRXATagMarker + s, "gi"), _ = 0; d > _; _++) {
                    a = h[_];
                    var p = "";
                    try {
                    ...
                    if (p && p.match(c)) {
                        ...
                        if (t.ie) jindo.$Element(a).attr({
                            ...
                            var f = jindo.$Element(a).html();
                            jindo.$Element(a).attr({
                                href: g,
                                target: sTarget
                            }), this._validateURL(f) && jindo.$Element(a).html(jindo.$Element(a).attr("href"))
                        }
                    }
                }
            }
    ...
    _isExceptional: function() {
        var e = jindo.$Agent().navigator(),
            t = !1,
            i = !1;
        return e.ie ? this.oApp.getWYSIWYGDocument().selection && "None" === this.oApp.getWYSIWYGDocument().selection.type && (t = jindo.$A(this.oSelection.getNodes()).some(function(e, t, i) {
            return 1 === e.nodeType && "IMG" === e.tagName ? !0 : void 0
        }, this)) ? !0 : e.nativeVersion > 8 ? !1 : (i = jindo.$A(this.oSelection.getTextNodes()).some(function(e, t, i) {
            return e.nodeValue.indexOf("@") >= 1 ? !0 : void 0
        }, this), i ? !0 : !1) : !1
    },
    ...
    _assignHTMLObjects: function(e) {
        this.oDropdownLayer = jindo.$$.getSingle("DIV.husky_se2m_lineHeight_layer", e), this.aLIOptions = jindo.$A(jindo.$$("LI", this.oDropdownLayer)).filter(function(e, t, i) {
            return null !== e.firstChild
    ...
    _setLineHeightAndCloseLayer: function(e) {
        ...
        t > 0 ? this.oApp.exec("SET_LINE_STYLE", ["lineHeight", t]) : alert(this.oApp.$MSG("SE_LineHeight.invalidLineHeight")), this.oApp.exec("SE2M_TOGGLE_LINEHEIGHT_LAYER", []);
        var i = jindo.$Agent().navigator();
    ...
    _clearOptionSelection: function(e) {
        for (var t = 0; t < this.aLIOptions.length; t++) jindo.$Element(this.aLIOptions[t].firstChild).removeClass("active")
    }
    ...
    $ON_OPEN_QE_LAYER: function(e, t, i) {
        if (this.waHotkeys.length() > 0 && !this.waHotkeyLayers.has(t)) {
            this.waHotkeyLayers.push(t);
            for (var n, o = 0, s = this.waHotkeys.length(); s > o; o++) n = this.waHotkeys.get(o), this.oApp.exec("ADD_HOTKEY", [n[0], n[1], n[2], t])
        }
        var r = i;
    ...
    $LOCAL_BEFORE_FIRST: function(e) {
        if (!e.match(/OPEN_QE_LAYER/)) return this.oApp.acceptLocalBeforeFirstAgain(this, !0), e.match(/REGISTER_HOTKEY/) ? !0 : !1;
        ...
        new jindo.DragArea(this._qe_wrap, {
            ...
            dragStart: function(e) {
                jindo.$Element(e.elDrag).hasClass("se2_qmax") || (e.elDrag = e.elDrag.parentNode), t.oApp.exec("SHOW_EDITING_AREA_COVER")
            },
            dragEnd: function(e) {
                t.changeFixedMode(), t._in_event = !1;
                var i = jindo.$Element(e.elDrag);
                t._environmentData[t._currentType].position = [i.css("top"), i.css("left")], t.oApp.exec("HIDE_EDITING_AREA_COVER")
            }
        });
        var i = jindo.$Fn(this.toggle, this).bind("img"),
            n = jindo.$Fn(this.toggle, this).bind("table");
        jindo.$Fn(i, this).attach(jindo.$$.getSingle(".q_open_img_fold", this.oApp.htOptions.elAppContainer), "click"), jindo.$Fn(i, this).attach(jindo.$$.getSingle(".q_open_img_full", this.oApp.htOptions.elAppContainer), "click"), jindo.$Fn(n, this).attach(jindo.$$.getSingle(".q_open_table_fold", this.oApp.htOptions.elAppContainer), "click"), jindo.$Fn(n, this).attach(jindo.$$.getSingle(".q_open_table_full", this.oApp.htOptions.elAppContainer), "click")
    },
    toggle: function(e, t) {
    ...
    getPositionInfo: function(e, t) {
        ...
        var i = {},
            ...
            s = {
                w: jindo.$Element(t).width(),
                h: jindo.$Element(t).height()
            };
        return n.x + s.w + this.nXGap > o.w ? i.x = o.w - s.w : i.x = n.x + this.nXGap, n.y + s.h + this.nYGap > o.h ? i.y = o.h - s.h - 2 : i.y = n.y + this.nYGap, {
            x: i.x,
            y: i.y
        }
    },
    getElementPosition: function(e, t) {
        var i, n, o, s, r, a;
        e ? (i = jindo.$Element(e), n = i.offset(), o = i.width(), s = i.height()) : (n = {
            top: parseInt(t.style.top, 10) - this.nYGap,
            left: parseInt(t.style.left, 10) - this.nXGap
        }, o = 0, s = 0);
        var l = this.oApp.getWYSIWYGWindow();
        "undefined" == typeof l.scrollX ? (r = l.document.documentElement.scrollLeft, a = l.document.documentElement.scrollTop) : (r = l.scrollX, a = l.scrollY);
        this.woEditor.offset();
        return {
            x: n.left - r + o,
            y: n.top - a + s
        }
    ...
    $ON_SHOW_DIALOG_LAYER: function(e, t) {
        if (e = jindo.$(e), t = t || {}, e && !jindo.$A(this.aOpenedLayers).has(e)) {
            this.oApp.exec("POSITION_DIALOG_LAYER", [e]), this.aOpenedLayers[this.aOpenedLayers.length] = e;
            var i, n = jindo.$A(this.aMadeDraggable).indexOf(e); - 1 == n ? (i = new nhn.DraggableLayer(e, t), this.aMadeDraggable[this.aMadeDraggable.length] = e, this.aDraggableLayer[this.aDraggableLayer.length] = i) : (t && (i = this.aDraggableLayer[n], i.setOptions(t)), e.style.display = "block"), t.sOnShowMsg && this.oApp.exec(t.sOnShowMsg, t.sOnShowParam)
        }
    },
    ...
    $ON_HIDE_ALL_DIALOG_LAYER: function() {
        for (var e = this.aOpenedLayers.length - 1; e >= 0; e--) this.oApp.exec("HIDE_DIALOG_LAYER", [this.aOpenedLayers[e]])
    },
    $ON_HIDE_DIALOG_LAYER: function(e) {
        e = jindo.$(e), e && (e.style.display = "none"), this.aOpenedLayers = jindo.$A(this.aOpenedLayers).refuse(e).$value()
    },
    ...
    $init: function(e) {
        if (this.sInlineContainer = "SPAN|B|U|I|S|STRIKE", this.rxInlineContainer = new RegExp("^(" + this.sInlineContainer + ")$"), this.window = e, this.document = this.window.document, this.document.domain != this.document.location.hostname) {
            var t = jindo.$Agent(),
                i = t.navigator();
            if (i.firefox && i.version < 3) return this.bBrowserSupported = !1, void(this.find = function() {
                return 3
            })
        }
        this._bLGDevice = navigator.userAgent.indexOf("LG-") > -1, this.bBrowserSupported = !0
    },
    find: function(e, t, i, n) {
        var o;
        return this._bLGDevice || this.window.focus(), e ? (this.bEOC = !1, (o = this.findNext(e, t, i, n)) ? 0 : (this.bEOC = !0, o = this.findNew(e, t, i, n), o ? 0 : 1)) : 2
    },
    ...
    findNext: function(e, t, i, n) {
        ...
        if (t = t || !1, n = n || !1, i = i || !1, this.window.find) {
            var s = !1;
            return "false" === this.document.body.contentEditable ? window.find(e, t, i, s, n) : this.window.find(e, t, i, s, n)
        }
        if (this.document.body.createTextRange) try {
            var r = 0;
            return i && (r += 1), n && (r += 2), t && (r += 4), this.window.focus(), this.document.selection ? (this._range = this.document.selection.createRangeCollection().item(0), this._range.collapse(!1)) : this._range ? this._range.collapse(!1) : this._range = this.document.body.createTextRange(), o = this._range.findText(e, 1, r), this._range.select(), o
        } catch (a) {
            return !1
        }
        return !1
    ...
    findReset: function() {
        return this.window.find ? void this.window.getSelection().removeAllRanges() : void(this.document.body.createTextRange && (this._range = this.document.body.createTextRange(), this._range.collapse(!0), this._range.select()))
    },
    ...
    _replace: function(e, t, i, n, o, s) {
        if (!e) return 4;
        s = s || new nhn.HuskyRange(this.window), s.setFromSelection(), i = i || !1;
        var r, a = s.toString();
        return (r = i ? a == e : a.toLowerCase() == e.toLowerCase()) ? ("function" == typeof t ? s = t(s) : s.pasteText(t), s.select(), this.find(e, i, n, o)) : this.find(e, i, n, o) + 2
    },
    replaceAll: function(e, t, i, n) {
        ...
        var o, s = !1,
            r = 0,
            a = this.window;
        if (0 !== this.find(e, i, s, n)) return r;
        var l = new nhn.HuskyRange(this.window);
        l.setFromSelection(), l.collapseToStart();
        var h = this.window.document.createElement("SPAN");
        h.innerHTML = unescape("%uFEFF"), l.insertNode(h), l.select();
        var d = l.placeStringBookmark();
        for (this.bEOC = !1; !this.bEOC;) o = this._replace(e, t, i, s, n, l), (0 == o || 1 == o) && r++;
        var c = function() {
            var e = new nhn.HuskyRange(a);
            e.setFromSelection(), l.moveToBookmark(d);
            var t = l.compareBoundaryPoints(nhn.W3CDOMRange.START_TO_END, e);
            return 1 == t ? !1 : !0
        };
        for (o = 0, this.bEOC = !1; !c() && 0 == o && !this.bEOC;) o = this._replace(e, t, i, s, n, l), (0 == o || 1 == o) && r++;
        return l.moveToBookmark(d), l.deleteContents(), l.removeStringBookmark(d), setTimeout(function() {
    ...
    _getNextTextNode: function(e, t) {
        for (var i, e;;)
            if (i = this._getNextNode(e, t), e = i.elNextNode, t = i.bDisconnected, e && 3 != e.nodeType && !this.rxInlineContainer.test(e.tagName) && (t = !0), !e || 3 == e.nodeType && !this._isBlankTextNode(e)) break;
        return {
            elNextText: e,
            bDisconnected: t
        }
    ...
    _getFirstTextNode: function() {
        ...
        if (!e) return null;
        if (3 != e.nodeType || this._isBlankTextNode(e)) {
            var t = this._getNextTextNode(e, !1);
            e = t.elNextText
        }
        return e
    },
    _addToTextMap: function(e, t, i, n) {
        for (var o = t[n].length, s = 0, r = e.nodeValue.length; r > s; s++) i[n][o + s] = [e, s];
        t[n] += e.nodeValue
    },
    _createTextMap: function() {
        for (var e = [], t = [], i = -1, n = this._getFirstTextNode(), o = {
                elNextText: n,
                bDisconnected: !0
            }; n;) o.bDisconnected && (i++, e[i] = "", t[i] = []), this._addToTextMap(o.elNextText, e, t, i), o = this._getNextTextNode(n, !1), n = o.elNextText;
        return {
            aTexts: e,
            aElTexts: t
        }
    ...
    replaceAll_js: function(e, t, i, n) {
        try {
            for (var o = (new Date, this._createTextMap()), s = (new Date, o.aTexts), r = o.aElTexts, a = 0, l = e.length, h = 0, d = s.length; d > h; h++)
                for (var c = s[h], _ = c.length - l; _ >= 0; _--) {
                    var p = c.substring(_, _ + l);
                    if (!(n && _ > 0 && c.charAt(_ - 1).match(/[a-zA-Z가-힣]/)) && p == e) {
                        a++;
                        var E, u, g = new nhn.HuskyRange(this.window);
                        _ + l < r[h].length ? (E = r[h][_ + l][0], u = r[h][_ + l][1]) : (E = r[h][_ + l - 1][0], u = r[h][_ + l - 1][1] + 1), g.setEnd(E, u, !0, !0), g.setStart(r[h][_][0], r[h][_][1], !0), "function" == typeof t ? g = t(g) : g.pasteText(t), _ -= l
                    }
                }
            return a
        } catch (f) {
