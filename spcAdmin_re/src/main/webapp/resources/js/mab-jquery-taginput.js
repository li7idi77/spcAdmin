...
;(function ( $, window, document, undefined ) {
    ...
    var _createTagInput = function(input, tagDataSeparator) {
        ...
        return $('<div class="mab-jquery-taginput' + ((input.attr('class')) ? ' ' + input.attr('class') : '') + '">' +
                 ...
                 '<input class="add_number" type="text"' + (input.is('[placeholder]') ? ' placeholder="' + input.attr('placeholder') : '') + '">' +
                 '</div>');
    };

    // Create HTML representing a tag
    var _createTag = function(tag) {
        return '<span class="label" data-tag="' + tag + '">' + tag + ' <span class="ico_remove"></span></span>';
    };
    ...
    Plugin.prototype = {
        ...
        init: function(element) {
            ...
            var tagInput = tagInputContainer.find('.add_number');
            ...
            tagInputContainer.on('click', 'span.ico_remove', function(e) {
